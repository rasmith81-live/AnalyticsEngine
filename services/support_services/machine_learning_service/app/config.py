"""
Configuration settings for Machine Learning Service.
"""
...
class Settings(BaseSettings):
    """Application settings for Machine Learning Service."""
    
    # Service Configuration
    service_name: str = Field(
        default="machine_learning_service",
        env="SERVICE_NAME",
    ...
    event_callback_url: str = Field(
        default="http://machine_learning_service:8002/events/callback",
