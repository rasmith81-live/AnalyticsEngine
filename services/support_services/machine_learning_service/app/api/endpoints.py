...
This module provides the API endpoints for Machine Learning Service functionality.
"""
...
async def request_data(
    ...
    try:
        ...
        message_id = await messaging_client.publish_event(
            event_type="data.request.machine_learning_service",
...
async def execute_command(
    ...
    try:
        ...
        message_id = await messaging_client.publish_event(
            event_type="command.machine_learning_service.execute",
            event_data={
