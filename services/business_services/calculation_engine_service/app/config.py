"""
Calculation Engine Service Configuration
"""
...
class CalculationEngineSettings(BaseSettings):
    """Calculation engine service configuration settings."""
    
    # Service Configuration
    service_name: str = Field(
        default="calculation_engine_service",
...
_settings: Optional[CalculationEngineSettings] = None


def get_settings() -> CalculationEngineSettings:
    """Get application settings singleton."""
    global _settings
    if _settings is None:
        _settings = CalculationEngineSettings()
    return _settings
