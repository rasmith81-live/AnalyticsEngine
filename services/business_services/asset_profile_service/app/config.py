"""
Configuration settings for Asset Profile Service.
"""
...
class Settings(BaseSettings):
    """Application settings for Asset Profile Service."""
    
    # Service Configuration
    service_name: str = Field(
        default="asset_profile_service",
        env="SERVICE_NAME",
    ...
    event_callback_url: str = Field(
        default="http://asset_profile_service:8003/events/callback",
