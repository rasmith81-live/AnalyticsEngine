"""
Configuration settings for Historical Data Provider Service.
"""
...
class Settings(BaseSettings):
    """Application settings for Historical Data Provider Service."""
    
    # Service Configuration
    service_name: str = Field(
        default="historical_data_provider_service",
        env="SERVICE_NAME",
    ...
    event_callback_url: str = Field(
        default="http://historical_data_provider_service:8002/events/callback",
