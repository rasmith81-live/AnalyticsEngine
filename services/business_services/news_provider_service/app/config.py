"""
Configuration settings for News Provider Service.
"""
...
class Settings(BaseSettings):
    """Application settings for News Provider Service."""
    
    # Service Configuration
    service_name: str = Field(
        default="news_provider_service",
        env="SERVICE_NAME",
    ...
    event_callback_url: str = Field(
        default="http://news_provider_service:8004/events/callback",
