"""
Configuration settings for the Allocation Service.
"""
...
class Settings(BaseSettings):
    """Application settings for the Allocation Service."""
    
    # Service Configuration
    service_name: str = Field(
        default="allocation_service",
        env="SERVICE_NAME",
    ...
    event_callback_url: str = Field(
        default="http://allocation_service:8007/events/callback",
