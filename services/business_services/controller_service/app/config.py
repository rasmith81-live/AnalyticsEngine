"""
Configuration settings for Controller Service.
"""
...
class Settings(BaseSettings):
    """Application settings for Controller Service."""
    
    # Service Configuration
    service_name: str = Field(
        default="controller_service",
        env="SERVICE_NAME",
    ...
    event_callback_url: str = Field(
        default="http://controller_service:8002/events/callback",
