"""
Configuration settings for Market Data Provider Service.
"""
...
class Settings(BaseSettings):
    """Application settings for Market Data Provider Service."""
    
    # Service Configuration
    service_name: str = Field(
        default="market_data_provider_service",
        env="SERVICE_NAME",
    ...
    event_callback_url: str = Field(
        default="http://market_data_provider_service:8003/events/callback",
