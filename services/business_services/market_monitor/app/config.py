"""
Configuration settings for the Market Monitor Service.
"""
...
class Settings(BaseSettings):
    """Application settings for the Market Monitor Service."""
    
    # Service Configuration
    service_name: str = Field(
        default="market_monitor",
        env="SERVICE_NAME",
    ...
    event_callback_url: str = Field(
        default="http://market_monitor:8008/events/callback",
