...
KEY_ACCOUNT_MANAGEMENT = {
    ...
    "is_active": True,
    "display_order": 6,
    "metadata_": {"value_chains": ["SALES_MGMT", "CUSTOMER_SUCCESS"], "industries": ["B2B", "ENTERPRISE", "TECHNOLOGY", "MANUFACTURING", "SERVICES"], "focus_areas": ["Strategic Account Planning", "Executive Relationship Management", "Account Growth & Expansion", "Account Health & Risk Management", "Multi-Stakeholder Engagement", "Account Retention & Renewal", "Value Delivery & ROI Demonstration"]},
