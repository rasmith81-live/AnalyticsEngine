...
PARTNER_TRAINING = {
    ...
    "table_schema": {"table_name": "partner_training", "class_name": "Partner Training", "columns": [{"name": "training_id", "type": "Integer", "index": True}, {"name": "training_name", "type": "String", "length": 255}, {"name": "training_type", "type": "String", "length": 50, "index": True}, {"name": "duration", "type": "String", "length": 255}, {"name": "completion_requirements", "type": "String", "length": 255}, {"name": "enrollment_date", "type": "DateTime", "index": True}, {"name": "completion_date", "type": "DateTime", "index": True}, {"name": "completion_status", "type": "String", "length": 50, "index": True}, {"name": "pre_training_performance", "type": "String", "length": 255}, {"name": "post_training_performance", "type": "String", "length": 255}, {"name": "created_at", "type": "DateTime", "default": "now()", "nullable": False}, {"name": "updated_at", "type": "DateTime", "default": "now()", "onupdate": "now()", "nullable": False}], "indexes": [{"name": "ix_partner_training_training_id", "columns": ["training_id"]}, {"name": "ix_partner_training_training_type", "columns": ["training_type"]}, {"name": "ix_partner_training_enrollment_date", "columns": ["enrollment_date"]}, {"name": "ix_partner_training_completion_date", "columns": ["completion_date"]}, {"name": "ix_partner_training_completion_status", "columns": ["completion_status"]}]},
    "schema_definition": """
    @startuml
' Relationships
