...
ACCOUNTS_PAYABLE = ObjectModel(
    ...
    table_schema={
        ...
        "columns": [
            {
                ...
                "primary_key": True,
                "autoincrement": True,
                "description": "Unique AP identifier"
            },
            {
                "name": "supplier_id",
                "type": "Integer",
            ...
            },
            {
                "name": "receipt_id",
                "type": "Integer",
                "foreign_key": "receipts.receipt_id",
                "index": True,
            ...
            },
            {
                ...
                "type": "Integer",
                "description": "Days from invoice to payment (DPO)"
            },
            {
                "name": "is_paid",
                "type": "Boolean",
            ...
            },
            {
                ...
                "nullable": False,
                "index": True,
                "description": "AP status (pending, approved, scheduled, paid, disputed)"
            },
            {
                "name": "gl_account",
                "type": "String",
        ...
        "indexes": [
            {
                "name": "ix_ap_supplier_id",
                "columns": ["supplier_id"]
            },
            {
                "name": "ix_ap_invoice_date",
        ...
        "constraints": [
            {
                ...
                "expression": "invoice_amount >= 0 AND amount_paid >= 0"
            }
        ]
    },
    ...
    metadata_={
        ...
        "scor_metrics": {
            "AM.1.1": {
                ...
                "calculation": "DPO = AVG(days_to_payment) OR (AP / COGS) * 365",
                "component": "Days Payable Outstanding"
            },
            "AM.1.2": {
                "name": "Return on Working Capital",
                "usage": "AP is part of current liabilities in working capital"
            }
        }
    }
)
