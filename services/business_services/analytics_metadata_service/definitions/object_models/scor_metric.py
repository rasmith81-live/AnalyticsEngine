...
SCOR_METRIC = ObjectModel(
    ...
    table_schema={
        "table_name": "scor_metric",
        "class_name": "SCOR Metric",
        "columns": [
            {
                "name": "id",
                "type": "String",
        ...
        "indexes": [
            {
                "name": "ix_scor_metric_created_at",
                "columns": ["created_at"]
            }
        ]
    },
...
@enduml
    ...
    metadata_={
        ...
        "implementation_note": "SCOR metrics are implemented as KPIs, not as Layer 2 table rows",
        ...
        "example_metrics": {
            "level_1": {
                ...
                "RS": ["RS.1.1 - Order Fulfillment Cycle Time"],
                "AG": ["AG.1.1 - Upside Supply Chain Flexibility"],
                "CO": ["CO.1.1 - Total Supply Chain Management Cost", "CO.1.2 - Cost of Goods Sold"],
                "PR": ["PR.1.1 - EBIT as % of Revenue"],
                "AM": ["AM.1.1 - Cash-to-Cash Cycle Time", "AM.1.2 - Return on Supply Chain Fixed Assets"],
                "EV": ["EV.1.1 - Carbon Emissions per Unit"],
                "SC": ["SC.1.1 - Worker Safety Incident Rate"]
            }
        }
    }
)
