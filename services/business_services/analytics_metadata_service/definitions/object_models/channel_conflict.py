...
CHANNEL_CONFLICT = {
    ...
    "table_schema": {"table_name": "channel_conflict", "class_name": "Channel Conflict", "columns": [{"name": "conflict_id", "type": "Integer", "index": True}, {"name": "conflict_type", "type": "String", "length": 50, "index": True}, {"name": "parties_involved", "type": "String", "length": 255}, {"name": "deal_id", "type": "Integer", "index": True}, {"name": "reported_date", "type": "DateTime", "index": True}, {"name": "resolution_date", "type": "DateTime", "index": True}, {"name": "resolution_outcome", "type": "String", "length": 255}, {"name": "status", "type": "String", "length": 255}, {"name": "created_at", "type": "DateTime", "default": "now()", "nullable": False}, {"name": "updated_at", "type": "DateTime", "default": "now()", "onupdate": "now()", "nullable": False}], "indexes": [{"name": "ix_channel_conflict_conflict_id", "columns": ["conflict_id"]}, {"name": "ix_channel_conflict_conflict_type", "columns": ["conflict_type"]}, {"name": "ix_channel_conflict_deal_id", "columns": ["deal_id"]}, {"name": "ix_channel_conflict_reported_date", "columns": ["reported_date"]}, {"name": "ix_channel_conflict_resolution_date", "columns": ["resolution_date"]}]},
    "schema_definition": """
    @startuml
' Relationships
...
@enduml
    """,
    "metadata_": {"modules": ["CHANNEL_SALES", "INSIDE_SALES", "KEY_ACCOUNT_MANAGEMENT", "OUTSIDE_SALES", "SALES_DEVELOPMENT", "SALES_ENABLEMENT", "SALES_OPERATIONS", "SALES_PERFORMANCE", "SALES_STRATEGY"], "related_kpis": ["CHANNEL_CONFLICT_RATE"], "key_attributes": ["conflict_id", "conflict_type", "parties_involved", "deal_id", "reported_date", "resolution_date", "resolution_outcome", "status"], "related_objects": ["Account", "Account Penetration", "Account Plan", "Account Risk", "Assessment", "Channel Deal", "Channel Market", "Channel Partner", "Churn Event", "Co-Marketing Campaign", "Competitive Analysis", "Contract", "Customer", "Customer Advocacy Program", "Customer Cohort", "Customer Community", "Customer Education", "Customer Feedback", "Customer Goal", "Customer Health Record"]},
}
