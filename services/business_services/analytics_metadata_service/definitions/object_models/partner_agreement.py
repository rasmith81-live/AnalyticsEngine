...
PARTNER_AGREEMENT = ObjectModel(
    ...
    table_schema={
        "table_name": "partner_agreement",
        "class_name": "Partner Agreement",
        "columns": [
            {
                "name": "agreement_id",
                "type": "Integer",
        ...
        "indexes": [
            {
                "name": "ix_partner_agreement_agreement_id",
            ...
            {
                "name": "ix_partner_agreement_end_date",
                "columns": ["end_date"]
            },
            {
                "name": "ix_partner_agreement_renewal_date",
                "columns": ["renewal_date"]
            },
            {
                "name": "ix_partner_agreement_compliance_status",
                "columns": ["compliance_status"]
            },
            {
                "name": "ix_partner_agreement_renewal_status",
                "columns": ["renewal_status"]
            }
        ]
    },
