...
RENEWAL_MANAGEMENT = ObjectModel(
    ...
    table_schema={
        "table_name": "renewal_management",
        "class_name": "Renewal Management",
        "columns": [
            {
                "name": "renewal_id",
                "type": "Integer",
        ...
        "indexes": [
            {
                "name": "ix_renewal_management_renewal_id",
                "columns": ["renewal_id"]
            },
            {
                "name": "ix_renewal_management_customer_id",
                "columns": ["customer_id"]
            },
            {
                "name": "ix_renewal_management_subscription_id",
                "columns": ["subscription_id"]
            },
            {
                "name": "ix_renewal_management_csm_id",
                "columns": ["csm_id"]
            },
            {
                "name": "ix_renewal_management_renewal_date",
...
@enduml
    ...
    metadata_={
        "modules": ["BUS_DEV", "CHANNEL_SALES", "CUSTOMER_RETENTION", "CUSTOMER_SUCCESS", "INSIDE_SALES", "KEY_ACCOUNT_MANAGEMENT", "OUTSIDE_SALES", "SALES_DEVELOPMENT", "SALES_ENABLEMENT", "SALES_OPERATIONS", "SALES_PERFORMANCE", "SALES_STRATEGY"],
        "related_kpis": [
            "RENEWAL_RATE",
