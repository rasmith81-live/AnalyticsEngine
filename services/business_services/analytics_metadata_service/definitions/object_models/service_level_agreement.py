...
SERVICE_LEVEL_AGREEMENT = ObjectModel(
    ...
    table_schema={
        "table_name": "service_level_agreement",
        "class_name": "Service Level Agreement",
        "columns": [
            {
                "name": "sla_id",
                "type": "Integer",
        ...
        "indexes": [
            {
                "name": "ix_service_level_agreement_sla_id",
                "columns": ["sla_id"]
            },
            {
                "name": "ix_service_level_agreement_customer_id",
                "columns": ["customer_id"]
            },
            {
                "name": "ix_service_level_agreement_start_date",
                "columns": ["start_date"]
            },
            {
                "name": "ix_service_level_agreement_end_date",
                "columns": ["end_date"]
            },
            {
                "name": "ix_service_level_agreement_compliance_status",
