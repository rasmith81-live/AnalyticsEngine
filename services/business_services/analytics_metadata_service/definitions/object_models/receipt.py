    ...
    table_schema={
        ...
        "columns": [
            ...
            },
            {
                ...
                "nullable": False,
                "index": True,
                "description": "Business receipt number"
            },
            {
            ...
            },
            {
                "name": "is_on_time",
                "type": "Boolean",
                "description": "Received by expected date"
            },
            {
                "name": "days_early_late",
                "type": "Integer",
                "description": "Days early (negative) or late (positive)"
            },
            {
                "name": "warehouse_id",
                "type": "Integer",
            ...
            },
            {
                ...
                "type": "String",
                "length": 100,
                "description": "Person who received goods"
            },
            {
                "name": "receipt_status",
                "type": "String",
                ...
                "nullable": False,
                "index": True,
                "description": "Receipt status (pending, received, inspected, accepted, rejected)"
            },
            {
            ...
            },
            {
                ...
                "type": "DateTime",
                "description": "Date of quality inspection"
            },
            {
        ...
        "indexes": [
            ...
            {
                "name": "ix_receipts_supplier_id",
                "columns": ["supplier_id"]
            },
            {
                "name": "ix_receipts_receipt_date",
        ...
        "constraints": [
            {
                "type": "check",
                "name": "chk_defect_count_non_negative",
                "expression": "defect_count >= 0"
            }
        ]
    },
    ...
    metadata_={
        ...
        "scor_metrics": {
            "AM.1.1": {
                ...
                "usage": "Receipt date starts DPO calculation (receipt_date to payment_date)"
            }
        }
    }
)
