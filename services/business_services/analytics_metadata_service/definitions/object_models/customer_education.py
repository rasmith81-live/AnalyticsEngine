...
CUSTOMER_EDUCATION = {
    ...
    "table_schema": {"table_name": "customer_education", "class_name": "Customer Education", "columns": [{"name": "education_id", "type": "Integer", "index": True}, {"name": "content_type", "type": "String", "length": 50, "index": True}, {"name": "topic", "type": "String", "length": 255}, {"name": "engagement_rate", "type": "Float"}, {"name": "completion_rate", "type": "Float"}, {"name": "customer_count", "type": "Integer"}, {"name": "effectiveness_score", "type": "Float"}, {"name": "created_at", "type": "DateTime", "default": "now()", "nullable": False}, {"name": "updated_at", "type": "DateTime", "default": "now()", "onupdate": "now()", "nullable": False}], "indexes": [{"name": "ix_customer_education_education_id", "columns": ["education_id"]}, {"name": "ix_customer_education_content_type", "columns": ["content_type"]}]},
    "schema_definition": """
    @startuml
' Relationships
