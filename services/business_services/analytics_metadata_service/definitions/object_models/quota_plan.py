...
QUOTA_PLAN = ObjectModel(
    ...
    table_schema={
        "table_name": "quota_plan",
        "class_name": "Quota Plan",
        "columns": [
            {
                "name": "plan_id",
                "type": "Integer",
        ...
        "indexes": [
            {
                "name": "ix_quota_plan_plan_id",
                "columns": ["plan_id"]
            },
            {
                "name": "ix_quota_plan_rep_id",
                "columns": ["rep_id"]
            }
        ]
    },
...
@enduml
    ...
    metadata_={
        "modules": ["BUS_DEV", "OUTSIDE_SALES", "SALES_DEVELOPMENT", "SALES_ENABLEMENT", "SALES_OPERATIONS", "SALES_PERFORMANCE", "SALES_STRATEGY", "SALES_TRAINING_COACHING"],
        "related_kpis": [
        ...
        "related_objects": ["Account Plan", "Competitive Analysis", "Deal", "Knowledge Base", "Meeting", "Opportunity", "Partner Training", "Performance Benchmark", "Performance Scorecard", "Product Adoption", "Product Usage", "Sales Pipeline", "Support Ticket", "Territory Assignment"]}
