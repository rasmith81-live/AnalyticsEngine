...
CHANNEL_PARTNER = ObjectModel(
    ...
    table_schema={
        "table_name": "channel_partner",
        "class_name": "Channel Partner",
        "columns": [
            {
                "name": "partner_id",
                "type": "Integer",
        ...
        "indexes": [
            {
                "name": "ix_channel_partner_partner_id",
                "columns": ["partner_id"]
            },
            {
                "name": "ix_channel_partner_partner_type",
                "columns": ["partner_type"]
            },
            {
                "name": "ix_channel_partner_onboarding_date",
                "columns": ["onboarding_date"]
            },
            {
            ...
            {
                "name": "ix_channel_partner_compliance_status",
