...
QUARTERLY_BUSINESS_REVIEW = {
    ...
    "table_schema": {"table_name": "quarterly_business_review", "class_name": "Quarterly Business Review", "columns": [{"name": "qbr_id", "type": "Integer", "index": True}, {"name": "customer_id", "type": "Integer", "index": True}, {"name": "date", "type": "String", "length": 255}, {"name": "quarter", "type": "String", "length": 255}, {"name": "attendees", "type": "String", "length": 255}, {"name": "topics_covered", "type": "String", "length": 255}, {"name": "action_items", "type": "String", "length": 255}, {"name": "satisfaction_score", "type": "Float"}, {"name": "created_at", "type": "DateTime", "default": "now()", "nullable": False}, {"name": "updated_at", "type": "DateTime", "default": "now()", "onupdate": "now()", "nullable": False}], "indexes": [{"name": "ix_quarterly_business_review_qbr_id", "columns": ["qbr_id"]}, {"name": "ix_quarterly_business_review_customer_id", "columns": ["customer_id"]}]},
    "schema_definition": """
    @startuml
' Relationships
