...
CUSTOMER_JOURNEY = {
    ...
    "table_schema": {"table_name": "customer_journey", "class_name": "Customer Journey", "columns": [{"name": "journey_id", "type": "Integer", "index": True}, {"name": "customer_id", "type": "Integer", "index": True}, {"name": "start_date", "type": "DateTime", "index": True}, {"name": "completion_date", "type": "DateTime", "index": True}, {"name": "completion_status", "type": "String", "length": 50, "index": True}, {"name": "effort_score", "type": "Float"}, {"name": "touchpoint_count", "type": "Integer"}, {"name": "stage_completion", "type": "String", "length": 255}, {"name": "created_at", "type": "DateTime", "default": "now()", "nullable": False}, {"name": "updated_at", "type": "DateTime", "default": "now()", "onupdate": "now()", "nullable": False}], "indexes": [{"name": "ix_customer_journey_journey_id", "columns": ["journey_id"]}, {"name": "ix_customer_journey_customer_id", "columns": ["customer_id"]}, {"name": "ix_customer_journey_start_date", "columns": ["start_date"]}, {"name": "ix_customer_journey_completion_date", "columns": ["completion_date"]}, {"name": "ix_customer_journey_completion_status", "columns": ["completion_status"]}]},
    "schema_definition": """
    @startuml
' Relationships
