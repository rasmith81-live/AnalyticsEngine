...
PRODUCT = {
    ...
    "table_schema": {"table_name": "product", "class_name": "Product", "columns": [{"name": "product_name", "type": "String", "length": 255}, {"name": "product_code", "type": "String", "length": 255}, {"name": "category", "type": "String", "length": 255}, {"name": "base_price", "type": "String", "length": 255}, {"name": "cost", "type": "String", "length": 255}, {"name": "margin", "type": "String", "length": 255}, {"name": "is_active", "type": "Boolean", "default": "False"}, {"name": "return_rate", "type": "Float"}, {"name": "created_at", "type": "DateTime", "default": "now()", "nullable": False}, {"name": "updated_at", "type": "DateTime", "default": "now()", "onupdate": "now()", "nullable": False}]},
    "schema_definition": """
    @startuml
' Sales Entities
' Customer Entities
...
@enduml
    """,
    "metadata_": {"modules": ["BUS_DEV", "CHANNEL_SALES", "CUSTOMER_RETENTION", "CUSTOMER_SUCCESS", "INSIDE_SALES", "KEY_ACCOUNT_MANAGEMENT", "INVENTORY_MGMT"], "related_kpis": ["PRODUCT_RETURN_RATE", "UPSELLING_RATE", "CROSS_SELLING_RATE"], "key_attributes": ["product_name", "product_code", "category", "base_price", "cost", "margin", "is_active", "return_rate"], "related_objects": ["Account", "Appointment", "Benchmark", "Certification", "Channel Partner", "Coaching Session", "Contract", "Customer", "Deal", "Demo", "Goal", "Lead", "Opportunity", "Sale", "Sales Content"]},
}
