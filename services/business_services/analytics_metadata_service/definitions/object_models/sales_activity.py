...
SALES_ACTIVITY = {
    ...
    "table_schema": {"table_name": "sales_activity", "class_name": "Sales Activity", "columns": [{"name": "activity_id", "type": "Integer", "index": True}, {"name": "rep_id", "type": "Integer", "index": True}, {"name": "activity_type", "type": "String", "length": 50, "index": True}, {"name": "date", "type": "String", "length": 255}, {"name": "duration", "type": "String", "length": 255}, {"name": "outcome", "type": "String", "length": 255}, {"name": "lead_id", "type": "Integer", "index": True}, {"name": "opportunity_id", "type": "Integer", "index": True}, {"name": "notes", "type": "String", "length": 255}, {"name": "created_at", "type": "DateTime", "default": "now()", "nullable": False}, {"name": "updated_at", "type": "DateTime", "default": "now()", "onupdate": "now()", "nullable": False}], "indexes": [{"name": "ix_sales_activity_activity_id", "columns": ["activity_id"]}, {"name": "ix_sales_activity_rep_id", "columns": ["rep_id"]}, {"name": "ix_sales_activity_activity_type", "columns": ["activity_type"]}, {"name": "ix_sales_activity_lead_id", "columns": ["lead_id"]}, {"name": "ix_sales_activity_opportunity_id", "columns": ["opportunity_id"]}]},
    "schema_definition": """
    @startuml
' Relationships
