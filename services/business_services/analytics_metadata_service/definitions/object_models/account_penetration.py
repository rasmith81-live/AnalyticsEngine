...
ACCOUNT_PENETRATION = {
    ...
    "table_schema": {"table_name": "account_penetration", "class_name": "Account Penetration", "columns": [{"name": "penetration_id", "type": "Integer", "index": True}, {"name": "account_id", "type": "Integer", "index": True}, {"name": "departments_served", "type": "String", "length": 255}, {"name": "total_departments", "type": "String", "length": 255}, {"name": "products_adopted", "type": "String", "length": 255}, {"name": "total_products", "type": "String", "length": 255}, {"name": "wallet_share", "type": "String", "length": 255}, {"name": "saturation_level", "type": "String", "length": 50, "index": True}, {"name": "penetration_score", "type": "Float"}, {"name": "created_at", "type": "DateTime", "default": "now()", "nullable": False}, {"name": "updated_at", "type": "DateTime", "default": "now()", "onupdate": "now()", "nullable": False}], "indexes": [{"name": "ix_account_penetration_penetration_id", "columns": ["penetration_id"]}, {"name": "ix_account_penetration_account_id", "columns": ["account_id"]}, {"name": "ix_account_penetration_saturation_level", "columns": ["saturation_level"]}]},
    "schema_definition": """
    @startuml
' Relationships
