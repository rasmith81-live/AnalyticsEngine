...
ENABLEMENT_FEEDBACK = {
    ...
    "table_schema": {"table_name": "enablement_feedback", "class_name": "Enablement Feedback", "columns": [{"name": "feedback_id", "type": "Integer", "index": True}, {"name": "rep_id", "type": "Integer", "index": True}, {"name": "date", "type": "String", "length": 255}, {"name": "type", "type": "String", "length": 255}, {"name": "satisfaction_score", "type": "Float"}, {"name": "response_time", "type": "DateTime", "index": True}, {"name": "action_taken", "type": "String", "length": 255}, {"name": "created_at", "type": "DateTime", "default": "now()", "nullable": False}, {"name": "updated_at", "type": "DateTime", "default": "now()", "onupdate": "now()", "nullable": False}], "indexes": [{"name": "ix_enablement_feedback_feedback_id", "columns": ["feedback_id"]}, {"name": "ix_enablement_feedback_rep_id", "columns": ["rep_id"]}, {"name": "ix_enablement_feedback_response_time", "columns": ["response_time"]}]},
    "schema_definition": """
    @startuml
' Relationships
...
@enduml
    """,
    "metadata_": {"modules": ["BUS_DEV", "CHANNEL_SALES", "CUSTOMER_RETENTION", "CUSTOMER_SUCCESS", "KEY_ACCOUNT_MANAGEMENT", "SALES_ENABLEMENT", "SALES_STRATEGY", "SALES_TRAINING_COACHING"], "related_kpis": ["SALES_ENABLEMENT_SATISFACTION_SCORE", "SALES_ENABLEMENT_FEEDBACK_RESPONSE_TIME", "SALES_FEEDBACK_LOOP_EFFECTIVENESS"], "key_attributes": ["feedback_id", "rep_id", "date", "type", "satisfaction_score", "response_time", "action_taken"], "related_objects": ["Account", "Account Penetration", "Account Plan", "Account Risk", "Assessment", "Call", "Certification", "Channel Conflict", "Channel Deal", "Channel Market", "Channel Partner", "Churn Event", "Coaching Session", "Competitive Analysis", "Customer", "Customer Advocacy Program", "Customer Cohort", "Customer Community", "Customer Education", "Customer Feedback"]},
}
