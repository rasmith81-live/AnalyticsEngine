...
PRODUCT_USAGE = ObjectModel(
    ...
    table_schema={
        ...
        "indexes": [
            {
                "name": "ix_product_usage_usage_id",
                "columns": ["usage_id"]
            },
            {
                "name": "ix_product_usage_customer_id",
                "columns": ["customer_id"]
            },
            {
                "name": "ix_product_usage_product_id",
                "columns": ["product_id"]
            },
            {
                "name": "ix_product_usage_engagement_level",
