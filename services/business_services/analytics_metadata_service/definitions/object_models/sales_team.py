...
SALES_TEAM = {
    ...
    "table_schema": {"table_name": "sales_team", "class_name": "Sales Team", "columns": [{"name": "team_name", "type": "String", "length": 255}, {"name": "team_lead", "type": "String", "length": 255}, {"name": "member_count", "type": "Integer"}, {"name": "assigned_accounts", "type": "String", "length": 255}, {"name": "target_accounts", "type": "String", "length": 255}, {"name": "team_quota", "type": "String", "length": 255}, {"name": "territory", "type": "String", "length": 255}, {"name": "created_at", "type": "DateTime", "default": "now()", "nullable": False}, {"name": "updated_at", "type": "DateTime", "default": "now()", "onupdate": "now()", "nullable": False}]},
    "schema_definition": """
    @startuml
' Relationships
...
@enduml
    """,
    "metadata_": {"modules": ["BUS_DEV"], "related_kpis": ["ACCOUNT_COVERAGE_RATIO", "SALES_TEAM_RESPONSE_TIME", "SALES_GROWTH"], "key_attributes": ["team_name", "team_lead", "member_count", "assigned_accounts", "target_accounts", "team_quota", "territory"], "related_objects": ["Account", "Appointment", "Assessment", "Call", "Channel Partner", "Coaching Session", "Contract", "Customer", "Deal", "Demo", "Goal", "Lead", "Meeting", "Opportunity", "Product"]},
}
