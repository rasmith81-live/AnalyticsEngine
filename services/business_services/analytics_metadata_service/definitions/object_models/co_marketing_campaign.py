...
CO_MARKETING_CAMPAIGN = ObjectModel(
    ...
    table_schema={
        "table_name": "co_marketing_campaign",
        "class_name": "Co-Marketing Campaign",
        "columns": [
            {
                "name": "campaign_id",
                "type": "Integer",
        ...
        "indexes": [
            {
                "name": "ix_co_marketing_campaign_campaign_id",
                "columns": ["campaign_id"]
            },
            {
                "name": "ix_co_marketing_campaign_start_date",
                "columns": ["start_date"]
            },
            {
                "name": "ix_co_marketing_campaign_end_date",
                "columns": ["end_date"]
            }
        ]
    },
