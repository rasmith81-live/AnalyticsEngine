...
CUSTOMER_GOAL = ObjectModel(
    ...
    table_schema={
        "table_name": "customer_goal",
        "class_name": "Customer Goal",
        "columns": [
            {
                "name": "goal_id",
                "type": "Integer",
        ...
        "indexes": [
            {
                "name": "ix_customer_goal_goal_id",
                "columns": ["goal_id"]
            },
            {
                "name": "ix_customer_goal_customer_id",
                "columns": ["customer_id"]
            },
            {
                "name": "ix_customer_goal_target_date",
                "columns": ["target_date"]
            },
            {
                "name": "ix_customer_goal_achievement_status",
                "columns": ["achievement_status"]
            }
        ]
    },
