...
CHURN_EVENT = ObjectModel(
    ...
    table_schema={
        "table_name": "churn_event",
        "class_name": "Churn Event",
        "columns": [
            {
                "name": "churn_id",
                "type": "Integer",
            ...
            {
                "name": "winback_attempted",
                "type": "DateTime",
                "index": True
            },
            {
                "name": "winback_successful",
                "type": "String",
                "length": 255
            },
            {
        ...
        "indexes": [
            {
                "name": "ix_churn_event_churn_id",
                "columns": ["churn_id"]
            },
            {
                "name": "ix_churn_event_customer_id",
                "columns": ["customer_id"]
            },
            {
                "name": "ix_churn_event_churn_date",
                "columns": ["churn_date"]
            },
            {
                "name": "ix_churn_event_save_attempted",
                "columns": ["save_attempted"]
            },
            {
                "name": "ix_churn_event_winback_attempted",
                "columns": ["winback_attempted"]
            }
        ]
    },
