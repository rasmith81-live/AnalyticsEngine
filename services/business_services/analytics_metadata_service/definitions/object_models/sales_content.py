...
SALES_CONTENT = ObjectModel(
    ...
    table_schema={
        "table_name": "sales_content",
        "class_name": "Sales Content",
        "columns": [
            {
                "name": "content_id",
                "type": "Integer",
        ...
        "indexes": [
            {
                "name": "ix_sales_content_content_id",
                "columns": ["content_id"]
            },
            {
                "name": "ix_sales_content_personalization_level",
                "columns": ["personalization_level"]
            }
        ]
    },
