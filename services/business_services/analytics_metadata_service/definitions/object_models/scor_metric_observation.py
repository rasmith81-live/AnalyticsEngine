...
SCOR_METRIC_OBSERVATION = ObjectModel(
    ...
    # Table Schema - Creates TimescaleDB hypertable
    table_schema={
        ...
        "indexes": [
            ...
            },
            {
                ...
                "columns": ["scor_metric_id", "timestamp", "organization_id"],
    ...
    metadata_={
        "modules": ["ASCM_SCOR"],
        "is_hypertable": True,
        "creates_layer_2_table": True,
        "time_series": True,
        "partition_by": "timestamp",
        "retention_policy": {
            "hot_data": "90 days",
            "warm_data": "1 year",
            "cold_data": "7 years (archived to Layer 2a)"
        },
        "example_observations": [
            ...
            {
                "scor_metric_id": "RS.1.1",
                "kpi_code": "ORDER_FULFILLMENT_CYCLE_TIME",
                "value": 2.3,
                "unit": "days",
                "timestamp": "2024-11-08T13:00:00Z",
                "context": {
            ...
            {
                "scor_metric_id": "CO.1.1",
                "kpi_code": "TOTAL_SUPPLY_CHAIN_COST",
                "value": 2500000,
                "unit": "dollars",
                "timestamp": "2024-11-08T13:00:00Z",
                "context": {
        ...
        "query_patterns": [
            ...
            "Multi-dimensional analysis (by region, product, etc.)",
            "Anomaly detection",
        ...
        "timescaledb_features": {
            ...
            "continuous_aggregates": [
                ...
                "daily_scor_metrics",
                "weekly_scor_metrics",
                "monthly_scor_metrics"
            ],
            "data_retention": "Automatic archival to Layer 2a after 1 year"
        }
    }
)
