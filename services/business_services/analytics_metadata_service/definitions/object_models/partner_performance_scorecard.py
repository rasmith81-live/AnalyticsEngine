...
PARTNER_PERFORMANCE_SCORECARD = {
    ...
    "table_schema": {"table_name": "partner_performance_scorecard", "class_name": "Partner Performance Scorecard", "columns": [{"name": "scorecard_id", "type": "Integer", "index": True}, {"name": "partner_id", "type": "Integer", "index": True}, {"name": "period", "type": "String", "length": 255}, {"name": "sales_score", "type": "Float"}, {"name": "growth_score", "type": "Float"}, {"name": "satisfaction_score", "type": "Float"}, {"name": "compliance_score", "type": "Float"}, {"name": "overall_score", "type": "Float"}, {"name": "ranking", "type": "String", "length": 255}, {"name": "created_at", "type": "DateTime", "default": "now()", "nullable": False}, {"name": "updated_at", "type": "DateTime", "default": "now()", "onupdate": "now()", "nullable": False}], "indexes": [{"name": "ix_partner_performance_scorecard_scorecard_id", "columns": ["scorecard_id"]}, {"name": "ix_partner_performance_scorecard_partner_id", "columns": ["partner_id"]}]},
    "schema_definition": """
    @startuml
' Relationships
