...
PARTNER_PERFORMANCE_SCORECARD = ObjectModel(
    ...
    table_schema={
        "table_name": "partner_performance_scorecard",
        "class_name": "Partner Performance Scorecard",
        "columns": [
            {
                "name": "scorecard_id",
                "type": "Integer",
        ...
        "indexes": [
            {
                "name": "ix_partner_performance_scorecard_scorecard_id",
                "columns": ["scorecard_id"]
            },
            {
                "name": "ix_partner_performance_scorecard_partner_id",
                "columns": ["partner_id"]
            }
        ]
    },
