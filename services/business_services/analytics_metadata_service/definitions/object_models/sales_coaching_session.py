...
SALES_COACHING_SESSION = {
    ...
    "table_schema": {"table_name": "sales_coaching_session", "class_name": "Sales Coaching Session", "columns": [{"name": "session_id", "type": "Integer", "index": True}, {"name": "coach_id", "type": "Integer", "index": True}, {"name": "rep_id", "type": "Integer", "index": True}, {"name": "date", "type": "String", "length": 255}, {"name": "type", "type": "String", "length": 255}, {"name": "effectiveness_score", "type": "Float"}, {"name": "topics_covered", "type": "String", "length": 255}, {"name": "created_at", "type": "DateTime", "default": "now()", "nullable": False}, {"name": "updated_at", "type": "DateTime", "default": "now()", "onupdate": "now()", "nullable": False}], "indexes": [{"name": "ix_sales_coaching_session_session_id", "columns": ["session_id"]}, {"name": "ix_sales_coaching_session_coach_id", "columns": ["coach_id"]}, {"name": "ix_sales_coaching_session_rep_id", "columns": ["rep_id"]}]},
    "schema_definition": """
    @startuml
' Relationships
...
@enduml
    """,
    "metadata_": {"modules": ["BUS_DEV", "CHANNEL_SALES", "CUSTOMER_RETENTION", "CUSTOMER_SUCCESS", "INSIDE_SALES", "KEY_ACCOUNT_MANAGEMENT", "OUTSIDE_SALES", "SALES_DEVELOPMENT", "SALES_ENABLEMENT", "SALES_OPERATIONS", "SALES_PERFORMANCE", "SALES_STRATEGY", "SALES_TRAINING_COACHING"], "related_kpis": ["SALES_COACHING_EFFECTIVENESS_RATE", "PEER_TO_PEER_COACHING_PARTICIPATION_RATE", "SALES_ROLE_PLAY_EFFECTIVENESS_SCORE"], "key_attributes": ["session_id", "coach_id", "rep_id", "date", "type", "effectiveness_score", "topics_covered"], "related_objects": ["Account", "Account Penetration", "Account Plan", "Account Risk", "Appointment", "Assessment", "Call", "Certification", "Channel Conflict", "Channel Deal", "Channel Market", "Channel Partner", "Churn Event", "Co-Marketing Campaign", "Coaching Session", "Competitive Analysis", "Contract", "Customer", "Customer Advocacy Program", "Customer Cohort"]},
}
