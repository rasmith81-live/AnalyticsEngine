...
PROSPECT_ENGAGEMENT = {
    ...
    "table_schema": {"table_name": "prospect_engagement", "class_name": "Prospect Engagement", "columns": [{"name": "engagement_id", "type": "Integer", "index": True}, {"name": "prospect_id", "type": "Integer", "index": True}, {"name": "engagement_score", "type": "Float"}, {"name": "last_contact_date", "type": "DateTime", "index": True}, {"name": "touchpoints", "type": "String", "length": 255}, {"name": "response_count", "type": "Integer"}, {"name": "created_at", "type": "DateTime", "default": "now()", "nullable": False}, {"name": "updated_at", "type": "DateTime", "default": "now()", "onupdate": "now()", "nullable": False}], "indexes": [{"name": "ix_prospect_engagement_engagement_id", "columns": ["engagement_id"]}, {"name": "ix_prospect_engagement_prospect_id", "columns": ["prospect_id"]}, {"name": "ix_prospect_engagement_last_contact_date", "columns": ["last_contact_date"]}]},
    "schema_definition": """
    @startuml
' Relationships
