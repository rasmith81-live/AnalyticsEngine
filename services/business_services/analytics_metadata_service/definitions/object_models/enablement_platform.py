...
ENABLEMENT_PLATFORM = {
    ...
    "table_schema": {"table_name": "enablement_platform", "class_name": "Enablement Platform", "columns": [{"name": "platform_id", "type": "Integer", "index": True}, {"name": "name", "type": "String", "length": 255}, {"name": "utilization_rate", "type": "Float"}, {"name": "adoption_rate", "type": "Float"}, {"name": "integration_level", "type": "String", "length": 50, "index": True}, {"name": "user_count", "type": "Integer"}, {"name": "created_at", "type": "DateTime", "default": "now()", "nullable": False}, {"name": "updated_at", "type": "DateTime", "default": "now()", "onupdate": "now()", "nullable": False}], "indexes": [{"name": "ix_enablement_platform_platform_id", "columns": ["platform_id"]}, {"name": "ix_enablement_platform_integration_level", "columns": ["integration_level"]}]},
    "schema_definition": """
    @startuml
' Relationships
...
@enduml
    """,
    "metadata_": {"modules": ["BUS_DEV", "CHANNEL_SALES", "CUSTOMER_SUCCESS", "SALES_ENABLEMENT"], "related_kpis": ["SALES_ENABLEMENT_PLATFORM_UTILIZATION_RATE", "SALES_TECHNOLOGY_ADOPTION_RATE", "SALES_TOOL_INTEGRATION_LEVEL"], "key_attributes": ["platform_id", "name", "utilization_rate", "adoption_rate", "integration_level", "user_count"], "related_objects": ["Assessment", "Call", "Certification", "Channel Conflict", "Channel Deal", "Channel Market", "Channel Partner", "Churn Event", "Coaching Session", "Customer", "Customer Advocacy Program", "Customer Cohort", "Customer Community", "Customer Education", "Customer Feedback", "Customer Goal", "Customer Health Record", "Customer Journey", "Customer Onboarding", "Customer Segment"]},
}
