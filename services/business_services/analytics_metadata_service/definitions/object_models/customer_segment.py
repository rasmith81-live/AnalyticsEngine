...
CUSTOMER_SEGMENT = {
    ...
    "table_schema": {"table_name": "customer_segment", "class_name": "Customer Segment", "columns": [{"name": "segment_id", "type": "Integer", "index": True}, {"name": "segment_name", "type": "String", "length": 255}, {"name": "criteria", "type": "String", "length": 255}, {"name": "customer_count", "type": "Integer"}, {"name": "revenue_contribution", "type": "String", "length": 255}, {"name": "retention_rate", "type": "Float"}, {"name": "effectiveness_score", "type": "Float"}, {"name": "created_at", "type": "DateTime", "default": "now()", "nullable": False}, {"name": "updated_at", "type": "DateTime", "default": "now()", "onupdate": "now()", "nullable": False}], "indexes": [{"name": "ix_customer_segment_segment_id", "columns": ["segment_id"]}]},
    "schema_definition": """
    @startuml
' Relationships
