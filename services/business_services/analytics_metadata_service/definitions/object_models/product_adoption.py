...
PRODUCT_ADOPTION = ObjectModel(
    ...
    table_schema={
        "table_name": "product_adoption",
        "class_name": "Product Adoption",
        "columns": [
            {
                "name": "adoption_id",
                "type": "Integer",
        ...
        "indexes": [
            {
                "name": "ix_product_adoption_adoption_id",
                "columns": ["adoption_id"]
            },
            {
                "name": "ix_product_adoption_customer_id",
                "columns": ["customer_id"]
            },
            {
                "name": "ix_product_adoption_product_id",
                "columns": ["product_id"]
            }
        ]
    },
