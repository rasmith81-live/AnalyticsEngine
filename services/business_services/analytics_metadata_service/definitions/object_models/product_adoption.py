...
PRODUCT_ADOPTION = {
    ...
    "table_schema": {"table_name": "product_adoption", "class_name": "Product Adoption", "columns": [{"name": "adoption_id", "type": "Integer", "index": True}, {"name": "customer_id", "type": "Integer", "index": True}, {"name": "product_id", "type": "Integer", "index": True}, {"name": "adoption_stage", "type": "String", "length": 255}, {"name": "features_adopted", "type": "String", "length": 255}, {"name": "usage_frequency", "type": "String", "length": 255}, {"name": "time_to_adopt", "type": "String", "length": 255}, {"name": "adoption_score", "type": "Float"}, {"name": "created_at", "type": "DateTime", "default": "now()", "nullable": False}, {"name": "updated_at", "type": "DateTime", "default": "now()", "onupdate": "now()", "nullable": False}], "indexes": [{"name": "ix_product_adoption_adoption_id", "columns": ["adoption_id"]}, {"name": "ix_product_adoption_customer_id", "columns": ["customer_id"]}, {"name": "ix_product_adoption_product_id", "columns": ["product_id"]}]},
    "schema_definition": """
    @startuml
' Relationships
