...
SALES_APPOINTMENT = {
    ...
    "table_schema": {"table_name": "sales_appointment", "class_name": "Sales Appointment", "columns": [{"name": "appointment_id", "type": "Integer", "index": True}, {"name": "rep_id", "type": "Integer", "index": True}, {"name": "account_id", "type": "Integer", "index": True}, {"name": "scheduled_date", "type": "DateTime", "index": True}, {"name": "appointment_type", "type": "String", "length": 50, "index": True}, {"name": "status", "type": "String", "length": 255}, {"name": "outcome", "type": "String", "length": 255}, {"name": "conversion_flag", "type": "String", "length": 255}, {"name": "created_at", "type": "DateTime", "default": "now()", "nullable": False}, {"name": "updated_at", "type": "DateTime", "default": "now()", "onupdate": "now()", "nullable": False}], "indexes": [{"name": "ix_sales_appointment_appointment_id", "columns": ["appointment_id"]}, {"name": "ix_sales_appointment_rep_id", "columns": ["rep_id"]}, {"name": "ix_sales_appointment_account_id", "columns": ["account_id"]}, {"name": "ix_sales_appointment_scheduled_date", "columns": ["scheduled_date"]}, {"name": "ix_sales_appointment_appointment_type", "columns": ["appointment_type"]}]},
    "schema_definition": """
    @startuml
' Relationships
