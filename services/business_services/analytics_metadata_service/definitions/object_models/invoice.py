    ...
    table_schema={
        ...
        "columns": [
            ...
            },
            {
                ...
                "type": "Integer",
                "description": "Days from invoice to payment (DSO)"
            },
            {
                "name": "is_paid",
                "type": "Boolean",
            ...
            },
            {
                ...
                "type": "DateTime",
                "description": "Date of last payment reminder"
            },
            {
                "name": "created_at",
                "type": "DateTime",
        ...
        "indexes": [
            ...
            {
                "name": "ix_invoices_composite",
                "columns": ["customer_id", "invoice_date", "is_paid"],
                "description": "Common query pattern for DSO calculation"
            }
        ],
        "constraints": [
            {
                "type": "check",
                "name": "chk_amounts_positive",
                "expression": "total_amount >= 0 AND amount_paid >= 0"
            },
            {
                "type": "check",
                "name": "chk_amount_due_calculation",
                "expression": "amount_due = total_amount - amount_paid"
            },
            {
                "type": "check",
    ...
    metadata_={
        ...
        "scor_metrics": {
            "AM.1.1": {
                ...
                "calculation": "DSO = AVG(days_to_payment) OR (AR / Revenue) * 365",
                "component": "Days Sales Outstanding"
            },
            "AM.1.2": {
                "name": "Return on Working Capital",
                "usage": "Accounts Receivable (amount_due) is part of working capital"
            }
        },
        "dso_calculation": {
            "method_1": "AVG(days_to_payment) for paid invoices",
            "method_2": "(Total AR / Total Revenue) * 365",
            "best_practice": "Calculate both and compare"
        }
    }
)
