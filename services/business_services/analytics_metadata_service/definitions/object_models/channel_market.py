...
CHANNEL_MARKET = {
    ...
    "table_schema": {"table_name": "channel_market", "class_name": "Channel Market", "columns": [{"name": "market_id", "type": "Integer", "index": True}, {"name": "market_name", "type": "String", "length": 255}, {"name": "region", "type": "String", "length": 255}, {"name": "country", "type": "String", "length": 255}, {"name": "total_addressable_market", "type": "String", "length": 255}, {"name": "current_penetration", "type": "String", "length": 255}, {"name": "market_share", "type": "String", "length": 255}, {"name": "growth_rate", "type": "Float"}, {"name": "created_at", "type": "DateTime", "default": "now()", "nullable": False}, {"name": "updated_at", "type": "DateTime", "default": "now()", "onupdate": "now()", "nullable": False}], "indexes": [{"name": "ix_channel_market_market_id", "columns": ["market_id"]}]},
    "schema_definition": """
    @startuml
' Relationships
