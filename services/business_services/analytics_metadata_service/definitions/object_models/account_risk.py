...
ACCOUNT_RISK = {
    ...
    "table_schema": {"table_name": "account_risk", "class_name": "Account Risk", "columns": [{"name": "risk_id", "type": "Integer", "index": True}, {"name": "account_id", "type": "Integer", "index": True}, {"name": "kam_id", "type": "Integer", "index": True}, {"name": "risk_level", "type": "String", "length": 50, "index": True}, {"name": "risk_factors", "type": "String", "length": 255}, {"name": "exposure_value", "type": "Float"}, {"name": "mitigation_plan", "type": "String", "length": 255}, {"name": "last_assessment_date", "type": "DateTime", "index": True}, {"name": "created_at", "type": "DateTime", "default": "now()", "nullable": False}, {"name": "updated_at", "type": "DateTime", "default": "now()", "onupdate": "now()", "nullable": False}], "indexes": [{"name": "ix_account_risk_risk_id", "columns": ["risk_id"]}, {"name": "ix_account_risk_account_id", "columns": ["account_id"]}, {"name": "ix_account_risk_kam_id", "columns": ["kam_id"]}, {"name": "ix_account_risk_risk_level", "columns": ["risk_level"]}, {"name": "ix_account_risk_last_assessment_date", "columns": ["last_assessment_date"]}]},
    "schema_definition": """
    @startuml
' Relationships
