    ...
    table_schema={
        ...
        "columns": [
            ...
            },
            {
                ...
                "nullable": False,
                "index": True,
                "description": "Revenue type (product_sales, service, freight, other)"
            },
            {
                "name": "order_id",
                "type": "Integer",
            ...
            },
            {
                "name": "order_line_id",
                "type": "Integer",
                "foreign_key": "order_lines.order_line_id",
                "index": True,
                "description": "Reference to order line"
            },
            {
                "name": "customer_id",
                "type": "Integer",
            ...
            },
            {
                ...
                "type": "Float",
                "description": "Revenue in USD (for aggregation)"
            },
            {
                "name": "quantity",
                "type": "Float",
            ...
            },
            {
                ...
                "type": "Float",
                "description": "COGS for this revenue"
            },
            {
                "name": "gross_profit",
                "type": "Float",
            ...
            },
            {
                ...
                "type": "Boolean",
                "default": False,
                "description": "Revenue has been recognized"
            },
            {
                "name": "recognition_method",
                "type": "String",
                "length": 50,
                "description": "Revenue recognition method (point_of_sale, delivery, etc.)"
            },
            {
                "name": "fiscal_year",
                "type": "Integer",
        ...
        "indexes": [
            {
                "name": "ix_revenue_revenue_date",
                "columns": ["revenue_date"]
            },
            {
                "name": "ix_revenue_order_id",
                "columns": ["order_id"]
            },
            {
                "name": "ix_revenue_customer_id",
                "columns": ["customer_id"]
            },
            {
                "name": "ix_revenue_product_id",
                "columns": ["product_id"]
            },
            {
                "name": "ix_revenue_channel",
                "columns": ["channel"]
            },
            {
                "name": "ix_revenue_region",
                "columns": ["region"]
            },
            {
                "name": "ix_revenue_fiscal_year",
                "columns": ["fiscal_year"]
            },
            {
                "name": "ix_revenue_composite",
                "columns": ["revenue_date", "customer_id", "product_id"],
        ...
        "constraints": [
            {
                "type": "check",
                "name": "chk_revenue_amount_positive",
            ...
            {
                "name": "chk_gross_margin_calculation",
                "expression": "gross_profit IS NULL OR gross_profit = revenue_amount - cost_of_goods_sold"
            }
        ]
    },
    ...
    metadata_={
        ...
        "scor_metrics": {
            "PR.1.1": {
                ...
                "calculation": "(Revenue - COGS - Operating Expense) / SC Fixed Assets",
                "usage": "Revenue is numerator component"
            },
            "AM.1.2": {
                "name": "Return on Working Capital",
                "calculation": "(Revenue - COGS - Operating Expense) / Working Capital",
                "usage": "Revenue is numerator component"
            }
        },
        "profitability_calculations": {
            "gross_profit": "revenue_amount - cost_of_goods_sold",
            "gross_margin_percent": "(gross_profit / revenue_amount) * 100"
        },
