...
SUBSCRIPTION = ObjectModel(
    ...
    table_schema={
        ...
        "indexes": [
            ...
            {
                "name": "ix_subscription_customer_id",
                "columns": ["customer_id"]
            },
            {
                "name": "ix_subscription_start_date",
                "columns": ["start_date"]
            },
            {
                "name": "ix_subscription_end_date",
                "columns": ["end_date"]
            },
            {
                "name": "ix_subscription_renewal_date",
                "columns": ["renewal_date"]
            },
            {
                "name": "ix_subscription_renewal_status",
