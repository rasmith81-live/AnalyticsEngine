...
CUSTOMER_HEALTH_RECORD = ObjectModel(
    ...
    table_schema={
        "table_name": "customer_health_record",
        "class_name": "Customer Health Record",
        "columns": [
            {
        ...
        "indexes": [
            {
                "name": "ix_customer_health_record_health_record_id",
                "columns": ["health_record_id"]
            },
            {
                "name": "ix_customer_health_record_customer_id",
                "columns": ["customer_id"]
            },
            {
                "name": "ix_customer_health_record_churn_risk_level",
