...
SALES_QUOTA = ObjectModel(
    ...
    table_schema={
        "table_name": "sales_quota",
        "class_name": "Sales Quota",
        "columns": [
            {
                "name": "quota_amount",
                "type": "Float"
        ...
        "indexes": [
            {
                "name": "ix_sales_quota_start_date",
                "columns": ["start_date"]
            },
            {
                "name": "ix_sales_quota_end_date",
                "columns": ["end_date"]
            },
            {
                "name": "ix_sales_quota_assignee_type",
                "columns": ["assignee_type"]
            },
            {
                "name": "ix_sales_quota_assignee_id",
                "columns": ["assignee_id"]
            }
        ]
    },
