...
ENERGY = ObjectModel(
    ...
    table_schema={
        ...
        "columns": [
            {"name": "energy_id", "type": "Integer", "primary_key": True, "autoincrement": True},
            {"name": "measurement_date", "type": "DateTime", "nullable": False, "index": True},
            {"name": "facility_id", "type": "Integer", "nullable": False, "index": True},
            {"name": "energy_type", "type": "String", "length": 50, "index": True, "description": "electricity, natural_gas, diesel, etc."},
            {"name": "consumption_amount", "type": "Float", "nullable": False},
            {"name": "unit_of_measure", "type": "String", "length": 20, "description": "kWh, therms, gallons"},
            {"name": "cost", "type": "Float"},
            {"name": "carbon_factor", "type": "Float", "description": "kg CO2 per unit"},
