...
CUSTOMER_COMMUNITY = {
    ...
    "table_schema": {"table_name": "customer_community", "class_name": "Customer Community", "columns": [{"name": "community_id", "type": "Integer", "index": True}, {"name": "name", "type": "String", "length": 255}, {"name": "member_count", "type": "Integer"}, {"name": "active_members", "type": "String", "length": 255}, {"name": "engagement_rate", "type": "Float"}, {"name": "post_count", "type": "Integer"}, {"name": "event_count", "type": "Integer"}, {"name": "created_at", "type": "DateTime", "default": "now()", "nullable": False}, {"name": "updated_at", "type": "DateTime", "default": "now()", "onupdate": "now()", "nullable": False}], "indexes": [{"name": "ix_customer_community_community_id", "columns": ["community_id"]}]},
    "schema_definition": """
    @startuml
' Relationships
