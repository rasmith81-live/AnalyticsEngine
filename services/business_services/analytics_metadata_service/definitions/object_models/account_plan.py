...
ACCOUNT_PLAN = ObjectModel(
    ...
    table_schema={
        "table_name": "account_plan",
        "class_name": "Account Plan",
        "columns": [
            {
                "name": "plan_id",
                "type": "Integer",
        ...
        "indexes": [
            {
                "name": "ix_account_plan_plan_id",
                "columns": ["plan_id"]
            },
            {
                "name": "ix_account_plan_account_id",
                "columns": ["account_id"]
            },
            {
                "name": "ix_account_plan_kam_id",
                "columns": ["kam_id"]
            },
            {
                "name": "ix_account_plan_created_date",
