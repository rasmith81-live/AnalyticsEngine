...
PERFORMANCE_BENCHMARK = {
    ...
    "table_schema": {"table_name": "performance_benchmark", "class_name": "Performance Benchmark", "columns": [{"name": "benchmark_id", "type": "Integer", "index": True}, {"name": "metric_name", "type": "String", "length": 255}, {"name": "industry_average", "type": "String", "length": 255}, {"name": "top_performer", "type": "String", "length": 255}, {"name": "target", "type": "String", "length": 255}, {"name": "actual", "type": "String", "length": 255}, {"name": "created_at", "type": "DateTime", "default": "now()", "nullable": False}, {"name": "updated_at", "type": "DateTime", "default": "now()", "onupdate": "now()", "nullable": False}], "indexes": [{"name": "ix_performance_benchmark_benchmark_id", "columns": ["benchmark_id"]}]},
    "schema_definition": """
    @startuml
' Relationships
