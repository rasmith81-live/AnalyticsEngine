...
COST_CENTER = ObjectModel(
    ...
    table_schema={
        ...
        "columns": [
            {"name": "cost_center_id", "type": "Integer", "primary_key": True, "autoincrement": True},
            {"name": "cost_center_code", "type": "String", "length": 50, "unique": True, "nullable": False, "index": True},
            {"name": "cost_center_name", "type": "String", "length": 200, "nullable": False},
            ...
            {"name": "manager", "type": "String", "length": 100},
