...
ORDER_LINE = ObjectModel(
    ...
    table_schema={
        ...
        "columns": [
            ...
            },
            {
                ...
                "type": "Integer",
                "nullable": False,
                "description": "Line number within order (1, 2, 3...)"
            },
            {
                "name": "product_id",
                "type": "Integer",
            ...
            },
            {
                ...
                "type": "String",
                "length": 200,
                "description": "Product name (denormalized for reporting)"
            },
            {
            ...
            },
            {
                "name": "line_cost",
                "type": "Float",
                "description": "Line cost (quantity * unit_cost)"
            },
            {
                "name": "line_margin",
                "type": "Float",
                "description": "Line margin (line_total - line_cost)"
            },
            {
                "name": "line_margin_percent",
                "type": "Float",
            ...
            },
            {
                ...
                "type": "Boolean",
                "default": False,
                "description": "Quantity delivered = quantity ordered"
            },
            {
                "name": "is_backordered",
                "type": "Boolean",
                "default": False,
                "description": "Item is on backorder"
            },
            {
                "name": "is_damaged",
                "type": "Boolean",
            ...
            },
            {
                ...
                "type": "String",
                "length": 50,
                "description": "Line status (pending, confirmed, picked, packed, shipped, delivered)"
            },
            {
                "name": "warehouse_id",
                "type": "Integer",
            ...
            },
            {
                ...
                "type": "String",
                "length": 100,
                "description": "Warehouse bin/location"
            },
            {
                "name": "shipment_id",
                "type": "Integer",
                ...
                "index": True,
                "description": "Reference to shipment"
            },
            {
                "name": "notes",
                "type": "Text",
        ...
        "indexes": [
            ...
            {
                "name": "ix_order_lines_shipment_id",
                "columns": ["shipment_id"]
            },
            {
                "name": "ix_order_lines_composite",
                "columns": ["order_id", "line_number"],
                "unique": True,
                "description": "Unique line number per order"
            }
        ],
        "constraints": [
            {
                ...
                "expression": "quantity_ordered > 0 AND quantity_shipped >= 0 AND quantity_delivered >= 0"
            },
            {
                "type": "check",
                "name": "chk_prices_positive",
                "expression": "unit_price >= 0 AND unit_cost >= 0"
            }
        ]
    },
    ...
    metadata_={
        ...
        "completeness_logic": {
            "is_complete": "quantity_delivered == quantity_ordered",
            "order_complete": "ALL order lines must be complete"
        },
        "scor_metrics": {
            "RL.1.1": {
                "name": "Perfect Order Fulfillment",
                "usage": "Check all lines complete (quantity_delivered = quantity_ordered)"
            },
            "CO.1.2": {
                "name": "Cost of Goods Sold",
                "calculation": "SUM(quantity_delivered * unit_cost)"
            }
        }
    }
)
