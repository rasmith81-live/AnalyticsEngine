...
PERFORMANCE_SCORECARD = {
    ...
    "table_schema": {"table_name": "performance_scorecard", "class_name": "Performance Scorecard", "columns": [{"name": "scorecard_id", "type": "Integer", "index": True}, {"name": "rep_id", "type": "Integer", "index": True}, {"name": "team_id", "type": "Integer", "index": True}, {"name": "period", "type": "String", "length": 255}, {"name": "metrics", "type": "String", "length": 255}, {"name": "scores", "type": "String", "length": 255}, {"name": "ranking", "type": "String", "length": 255}, {"name": "benchmark_comparison", "type": "String", "length": 255}, {"name": "created_at", "type": "DateTime", "default": "now()", "nullable": False}, {"name": "updated_at", "type": "DateTime", "default": "now()", "onupdate": "now()", "nullable": False}], "indexes": [{"name": "ix_performance_scorecard_scorecard_id", "columns": ["scorecard_id"]}, {"name": "ix_performance_scorecard_rep_id", "columns": ["rep_id"]}, {"name": "ix_performance_scorecard_team_id", "columns": ["team_id"]}]},
    "schema_definition": """
    @startuml
' Relationships
...
@enduml
    """,
    "metadata_": {"modules": ["SALES_PERFORMANCE"], "related_kpis": ["QUOTA_ATTAINMENT_PER_SALESPERSON", "SALES_PER_REPRESENTATIVE", "SALES_PRODUCTIVITY", "SALES_FORCE_EFFECTIVENESS"], "key_attributes": ["scorecard_id", "rep_id", "team_id", "period", "metrics", "scores", "ranking", "benchmark_comparison"], "related_objects": ["Call", "Channel Partner", "Customer", "Deal", "Email", "Lead", "Meeting", "Opportunity", "Sale", "Sales Representative"]},
}
