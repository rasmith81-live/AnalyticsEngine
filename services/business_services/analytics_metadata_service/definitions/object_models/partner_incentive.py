...
PARTNER_INCENTIVE = {
    ...
    "table_schema": {"table_name": "partner_incentive", "class_name": "Partner Incentive", "columns": [{"name": "incentive_id", "type": "Integer", "index": True}, {"name": "incentive_name", "type": "String", "length": 255}, {"name": "incentive_type", "type": "String", "length": 50, "index": True}, {"name": "value", "type": "String", "length": 255}, {"name": "eligibility_criteria", "type": "String", "length": 255}, {"name": "total_offered", "type": "String", "length": 255}, {"name": "total_claimed", "type": "String", "length": 255}, {"name": "utilization_rate", "type": "Float"}, {"name": "created_at", "type": "DateTime", "default": "now()", "nullable": False}, {"name": "updated_at", "type": "DateTime", "default": "now()", "onupdate": "now()", "nullable": False}], "indexes": [{"name": "ix_partner_incentive_incentive_id", "columns": ["incentive_id"]}, {"name": "ix_partner_incentive_incentive_type", "columns": ["incentive_type"]}]},
    "schema_definition": """
    @startuml
' Relationships
...
@enduml
    """,
    "metadata_": {"modules": ["BUS_DEV", "CHANNEL_SALES", "SALES_OPERATIONS", "SALES_PERFORMANCE"], "related_kpis": ["PARTNER_INCENTIVE_UTILIZATION_RATE"], "key_attributes": ["incentive_id", "incentive_name", "incentive_type", "value", "eligibility_criteria", "total_offered", "total_claimed", "utilization_rate"], "related_objects": ["Account", "Account Penetration", "Account Plan", "Account Risk", "Assessment", "Channel Conflict", "Channel Deal", "Channel Market", "Channel Partner", "Churn Event", "Co-Marketing Campaign", "Competitive Analysis", "Contract", "Customer", "Customer Advocacy Program", "Customer Cohort", "Customer Community", "Customer Education", "Customer Feedback", "Customer Goal"]},
}
