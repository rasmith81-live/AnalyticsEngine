...
SALES_TRAINING_PROGRAM = {
    ...
    "table_schema": {"table_name": "sales_training_program", "class_name": "Sales Training Program", "columns": [{"name": "program_id", "type": "Integer", "index": True}, {"name": "name", "type": "String", "length": 255}, {"name": "type", "type": "String", "length": 255}, {"name": "duration", "type": "String", "length": 255}, {"name": "completion_rate", "type": "Float"}, {"name": "impact_score", "type": "Float"}, {"name": "attendance_rate", "type": "Float"}, {"name": "created_at", "type": "DateTime", "default": "now()", "nullable": False}, {"name": "updated_at", "type": "DateTime", "default": "now()", "onupdate": "now()", "nullable": False}], "indexes": [{"name": "ix_sales_training_program_program_id", "columns": ["program_id"]}]},
    "schema_definition": """
    @startuml
' Relationships
...
@enduml
    """,
    "metadata_": {"modules": ["BUS_DEV", "CHANNEL_SALES", "CUSTOMER_RETENTION", "CUSTOMER_SUCCESS", "INSIDE_SALES", "KEY_ACCOUNT_MANAGEMENT", "OUTSIDE_SALES", "SALES_DEVELOPMENT", "SALES_ENABLEMENT", "SALES_OPERATIONS", "SALES_PERFORMANCE", "SALES_STRATEGY", "SALES_TRAINING_COACHING"], "related_kpis": ["SALES_TRAINING_ATTENDANCE_RATE", "SALES_TRAINING_COMPLETION_RATE", "TRAINING_IMPACT_SCORE", "SALES_ONBOARDING_EFFICIENCY"], "key_attributes": ["program_id", "name", "type", "duration", "completion_rate", "impact_score", "attendance_rate"], "related_objects": ["Account", "Account Penetration", "Account Plan", "Account Risk", "Appointment", "Assessment", "Call", "Certification", "Channel Conflict", "Channel Deal", "Channel Market", "Channel Partner", "Churn Event", "Co-Marketing Campaign", "Coaching Session", "Competitive Analysis", "Contract", "Customer", "Customer Advocacy Program", "Customer Cohort"]},
}
