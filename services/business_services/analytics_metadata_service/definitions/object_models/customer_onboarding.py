...
CUSTOMER_ONBOARDING = {
    ...
    "table_schema": {"table_name": "customer_onboarding", "class_name": "Customer Onboarding", "columns": [{"name": "onboarding_id", "type": "Integer", "index": True}, {"name": "customer_id", "type": "Integer", "index": True}, {"name": "start_date", "type": "DateTime", "index": True}, {"name": "completion_date", "type": "DateTime", "index": True}, {"name": "success_status", "type": "String", "length": 50, "index": True}, {"name": "satisfaction_score", "type": "Float"}, {"name": "milestones_completed", "type": "String", "length": 255}, {"name": "time_to_value", "type": "Float"}, {"name": "created_at", "type": "DateTime", "default": "now()", "nullable": False}, {"name": "updated_at", "type": "DateTime", "default": "now()", "onupdate": "now()", "nullable": False}], "indexes": [{"name": "ix_customer_onboarding_onboarding_id", "columns": ["onboarding_id"]}, {"name": "ix_customer_onboarding_customer_id", "columns": ["customer_id"]}, {"name": "ix_customer_onboarding_start_date", "columns": ["start_date"]}, {"name": "ix_customer_onboarding_completion_date", "columns": ["completion_date"]}, {"name": "ix_customer_onboarding_success_status", "columns": ["success_status"]}]},
    "schema_definition": """
    @startuml
' Relationships
