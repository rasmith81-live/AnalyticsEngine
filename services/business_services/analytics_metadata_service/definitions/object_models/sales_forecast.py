...
SALES_FORECAST = ObjectModel(
    ...
    table_schema={
        ...
        "indexes": [
            {
                "name": "ix_sales_forecast_forecast_id",
                "columns": ["forecast_id"]
            },
            {
                "name": "ix_sales_forecast_rep_id",
                "columns": ["rep_id"]
            },
            {
                "name": "ix_sales_forecast_team_id",
                "columns": ["team_id"]
            },
            {
                "name": "ix_sales_forecast_forecast_date",
