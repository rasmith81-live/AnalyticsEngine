...
PROFIT_CONTRIBUTION_PER_ACCOUNT = KPI(
    ...
    * However, focusing solely on profit contribution without considering customer satisfaction and long-term value may lead to short-sighted decisions.
    ...
    metadata_={
        ...
        "required_objects": ["Account", "Account Penetration", "Account Plan", "Account Risk", "Customer", "Key Account", "Key Account Manager", "Renewal Management", "Revenue Forecast", "Sale"]
    }
)
