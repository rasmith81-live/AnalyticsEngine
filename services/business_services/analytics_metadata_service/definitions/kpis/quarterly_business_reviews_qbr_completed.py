"""
Quarterly Business Reviews (QBR) Completed
...
QUARTERLY_BUSINESS_REVIEWS_QBR_COMPLETED = {
    ...
    "is_active": True,
    "full_kpi_definition": "Complete definition for Quarterly Business Reviews (QBR) Completed to be added.",
    "trend_analysis": """
    ...
    * Conversely, a decline in QBR completion may result in decreased customer loyalty and potential revenue loss.
    ...
    "sample_data": {
        ...
        "metadata": {
                "generated_date": "2025-11-10T13:51:12.729979",
                "data_points": 12,
                "kpi_type": "count",
                "kpi_name": "Quarterly Business Reviews (QBR) Completed"
        }
    },
}
