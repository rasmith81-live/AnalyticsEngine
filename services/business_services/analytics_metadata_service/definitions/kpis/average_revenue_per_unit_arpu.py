...
AVERAGE_REVENUE_PER_UNIT_ARPU = {
    ...
    "actionable_steps": {"operational": ["Focus on cross-selling and upselling to existing customers to increase the average revenue per unit."], "strategic": ["Regularly review and adjust pricing strategies to maximize ARPU without sacrificing customer satisfaction.", "Introduce premium or value-added features to existing products or services to justify higher prices."]},
    ...
    "metadata_": {"modules": ["BUS_DEV", "SALES_PERFORMANCE"], "value_chains": ["SALES_MGMT"], "source": "kpidepot.com", "required_objects": ["Customer", "Customer Advocacy Program", "Customer Cohort", "Customer Community", "Customer Education", "Customer Feedback", "Customer Goal", "Customer Health Record", "Customer Journey", "Customer Onboarding", "Customer Segment", "Customer Success Manager", "Product", "Quarterly Business Review", "Revenue Forecast", "Sale"]},
