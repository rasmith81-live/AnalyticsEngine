...
PARTNER_BRAND_ALIGNMENT = KPI(
    ...
    kpi_definition="The degree to which channel partners\' branding and messaging align with the company\'s brand, ensuring a consistent customer experience.",
    expected_business_insights="Ensures brand consistency across all channels which contributes to customer trust and brand equity.",
    measurement_approach="Evaluates the consistency of partners’ marketing and sales practices with the company’s brand guidelines.",
