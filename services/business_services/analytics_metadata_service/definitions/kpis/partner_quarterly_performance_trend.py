"""
Partner Quarterly Performance Trend KPI
...
PARTNER_QUARTERLY_PERFORMANCE_TREND = KPI(
    ...
    kpi_definition="The analysis of channel partner performance over a quarter, showing trends and patterns that can indicate areas of improvement or success.",
    expected_business_insights="Identifies trends that may influence resource allocation and strategic planning for the partner channel.",
    measurement_approach="Analyzes patterns in partner sales and other performance metrics on a quarterly basis.",
    ...
    * However, changes in partner performance may require adjustments in sales forecasts and resource allocation.
    ...
    metadata_={
        ...
        "required_objects": ["Channel Conflict", "Channel Deal", "Channel Market", "Channel Partner", "Competitive Analysis", "Customer Success Manager", "Partner Agreement", "Partner Incentive", "Partner Performance Scorecard", "Partner Portal", "Partner Training", "Performance Benchmark", "Performance Scorecard", "Quarterly Business Review", "Sales Activity", "Sales Appointment", "Sales Assessment", "Sales Call", "Sales Coaching Session", "Sales Content", "Sales Dashboard", "Sales Email", "Sales Forecast", "Sales Playbook", "Sales Process Workflow", "Sales Quota", "Sales Representative", "Sales Team", "Sales Territory", "Sales Training Program"]
    }
)
