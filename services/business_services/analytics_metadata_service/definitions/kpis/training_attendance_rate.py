...
TRAINING_ATTENDANCE_RATE = {
    ...
    "is_active": True,
    "full_kpi_definition": "Complete definition for Training Attendance Rate to be added.",
    "trend_analysis": """
    ...
    * However, a heavy focus on attendance numbers alone may overlook the quality and effectiveness of the training content, so a balanced approach is necessary.
    ...
    "sample_data": {
        ...
        "metadata": {
                "generated_date": "2025-11-10T13:51:13.822048",
                "data_points": 12,
                "kpi_type": "percentage",
                "kpi_name": "Training Attendance Rate"
        }
    },
}
