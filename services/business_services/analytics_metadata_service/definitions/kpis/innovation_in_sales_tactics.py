"""
Innovation in Sales Tactics KPI
...
INNOVATION_IN_SALES_TACTICS = KPI(
    ...
    kpi_definition="The rate at which new and innovative sales tactics are adopted by sales reps post-training.",
    expected_business_insights="Demonstrates the ability of training to inspire innovation and adaptation in sales strategies, potentially leading to a competitive advantage.",
    measurement_approach="The measure of new and creative sales approaches adopted by sales reps post-training.",
