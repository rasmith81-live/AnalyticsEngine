...
NEGOTIATION_TO_CLOSE_RATIO = KPI(
    ...
    * However, overly aggressive negotiation tactics may negatively impact customer relationships and long-term loyalty.
    ...
    metadata_={
        ...
        "required_objects": ["Deal", "Opportunity", "Sales Activity", "Sales Appointment", "Sales Assessment", "Sales Call", "Sales Coaching Session", "Sales Content", "Sales Dashboard", "Sales Email", "Sales Forecast", "Sales Playbook", "Sales Process Workflow", "Sales Quota", "Sales Representative", "Sales Team", "Sales Territory", "Sales Training Program"]
    }
)
