...
VOICE_OF_THE_CUSTOMER_VOC_EFFECTIVENESS = {
    ...
    * Decreasing impact of customer feedback may result in reduced customer retention and negative brand perception.
    """,
    "metadata_": {"modules": ["CUSTOMER_RETENTION"], "source": "kpidepot.com", "import_date": "2025-11-07", "required_objects": ["Customer", "Customer Advocacy Program", "Customer Cohort", "Customer Community", "Customer Education", "Customer Feedback", "Customer Goal", "Customer Health Record", "Customer Journey", "Customer Onboarding", "Customer Segment", "Customer Success Manager", "Enablement Feedback", "Quarterly Business Review"]},
