...
PRODUCT_QUALITY_SCORE = {
    ...
    * Conversely, declining product quality scores may result in increased customer complaints, returns, and decreased sales.
    """,
    "metadata_": {"modules": ["CUSTOMER_SUCCESS"], "source": "kpidepot.com", "import_date": "2025-11-07", "required_objects": ["Customer", "Customer Advocacy Program", "Customer Cohort", "Customer Community", "Customer Education", "Customer Feedback", "Customer Goal", "Customer Health Record", "Customer Journey", "Customer Onboarding", "Customer Segment", "Customer Success Manager", "Enablement Feedback", "Product", "Product Adoption", "Product Usage"]},
