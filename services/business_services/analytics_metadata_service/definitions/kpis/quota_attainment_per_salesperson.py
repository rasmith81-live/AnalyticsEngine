...
QUOTA_ATTAINMENT_PER_SALESPERSON = KPI(
    ...
    * Low quota attainment can impact overall sales team morale and the organization\'s ability to meet financial targets.
    ...
    metadata_={
        ...
        "required_objects": ["Partner Performance Scorecard", "Performance Benchmark", "Performance Scorecard", "Quota Plan", "Sale", "Sales Activity", "Sales Appointment", "Sales Assessment", "Sales Call", "Sales Coaching Session", "Sales Content", "Sales Dashboard", "Sales Email", "Sales Forecast", "Sales Playbook", "Sales Process Workflow", "Sales Quota", "Sales Representative", "Sales Team", "Sales Territory", "Sales Training Program"]
    }
)
