...
from definition_loader import load_definition_file, load_all_object_models, update_definition_field, add_definition_field
...
def extract_object_info(obj_file):
    ...
    if not obj_data:
        return {'name': None, 'code': None, 'content': ''}
