...
YEAR_OVER_YEAR_YOY_SALES_COMPARISON = KPI(
    ...
    * Conversely, declining sales performance may necessitate cost-cutting measures or strategic repositioning to remain competitive.
    ...
    metadata_={
        ...
        "required_objects": ["Partner Performance Scorecard", "Performance Benchmark", "Performance Scorecard", "Sale", "Sales Activity", "Sales Appointment", "Sales Assessment", "Sales Call", "Sales Coaching Session", "Sales Content", "Sales Dashboard", "Sales Email", "Sales Forecast", "Sales Playbook", "Sales Process Workflow", "Sales Quota", "Sales Representative", "Sales Team", "Sales Territory", "Sales Training Program"]
    }
)
