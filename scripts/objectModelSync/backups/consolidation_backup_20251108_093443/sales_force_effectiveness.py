...
SALES_FORCE_EFFECTIVENESS = KPI(
    ...
    kpi_definition="A measure of the productivity and efficiency of the sales force in terms of revenue generated, costs, and overall profitability.",
    expected_business_insights="Evaluates overall sales team performance, guiding training and development.",
    measurement_approach="Combines multiple metrics like customer reach, conversion rates, and sales volume.",
