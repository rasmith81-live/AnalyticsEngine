...
CUSTOMER_SEGMENTATION_EFFECTIVENESS = KPI(
    ...
    kpi_definition="The success of marketing and sales strategies targeted at specific customer segments.",
    expected_business_insights="Determines how well customer segmentation aligns with customer needs and behaviors, enhancing personalization.",
    measurement_approach="Evaluates the success of dividing customers into segments for targeted marketing and service.",
