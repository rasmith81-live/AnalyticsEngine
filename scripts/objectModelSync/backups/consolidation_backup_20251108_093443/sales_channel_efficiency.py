...
SALES_CHANNEL_EFFICIENCY = KPI(
    ...
    kpi_definition="The efficiency of different sales channels assessed by metrics such as sales volume, customer reach, and conversion rates.",
    expected_business_insights="Guides strategic decisions on channel investment and optimization.",
    measurement_approach="Assesses the effectiveness of various sales channels by measuring revenue, customer acquisition, or other performance metrics.",
