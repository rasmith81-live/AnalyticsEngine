...
CUSTOMER_ISSUE_RESOLUTION_RATE = {
    ...
    * However, a focus solely on increasing the rate may lead to rushed or inadequate resolutions, impacting overall customer satisfaction.
    ...
    """,
    "metadata_": {"modules": ["CUSTOMER_SUCCESS", "SALES_OPERATIONS"], "source": "kpidepot.com", "import_date": "2025-11-07", "required_objects": ["Customer", "Customer Advocacy Program", "Customer Cohort", "Customer Community", "Customer Education", "Customer Feedback", "Customer Goal", "Customer Health Record", "Customer Journey", "Customer Onboarding", "Customer Segment", "Customer Success Manager", "Support Ticket"], "replaces": ["CUSTOMER_PROBLEM_RESOLUTION_RATE"], "last_validated": "2025-11-10T13:43:23.287329"},
    "required_objects": [],
