...
CUSTOMER_COMMUNITY_ENGAGEMENT_RATE = {
    ...
    * Conversely, a decline in engagement may result in negative word-of-mouth, reduced customer trust, and ultimately, decreased revenue.
    ...
    """,
    "metadata_": {"modules": ["CUSTOMER_SUCCESS"], "source": "kpidepot.com", "import_date": "2025-11-07", "required_objects": ["Customer", "Customer Advocacy Program", "Customer Cohort", "Customer Community", "Customer Education", "Customer Feedback", "Customer Goal", "Customer Health Record", "Customer Journey", "Customer Onboarding", "Customer Segment", "Customer Success Manager", "Lead", "Prospect Engagement", "Service Level Agreement"], "last_validated": "2025-11-10T13:43:23.222407"},
    "required_objects": [],
