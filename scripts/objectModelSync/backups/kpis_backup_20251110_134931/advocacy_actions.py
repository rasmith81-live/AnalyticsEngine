...
ADVOCACY_ACTIONS = {
    ...
    * Conversely, a decline in advocacy actions may result in decreased trust and loyalty, affecting customer retention and lifetime value.
    ...
    """,
    "metadata_": {"modules": ["CUSTOMER_SUCCESS"], "source": "kpidepot.com", "import_date": "2025-11-07", "required_objects": ["Customer", "Customer Advocacy Program", "Customer Cohort", "Customer Community", "Customer Education", "Customer Feedback", "Customer Goal", "Customer Health Record", "Customer Journey", "Customer Onboarding", "Customer Segment", "Customer Success Manager", "Deal", "Lead", "Opportunity"], "last_validated": "2025-11-10T13:43:23.006539"},
    "required_objects": [],
