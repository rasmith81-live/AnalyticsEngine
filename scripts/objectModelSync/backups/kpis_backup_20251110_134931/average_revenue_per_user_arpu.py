...
AVERAGE_REVENUE_PER_USER_ARPU = {
    ...
    * Decreasing ARPU may indicate a need for cost-cutting measures, but could also signal a decline in customer satisfaction and loyalty.
    ...
    """,
    "metadata_": {"modules": ["CUSTOMER_RETENTION"], "source": "kpidepot.com", "import_date": "2025-11-07", "required_objects": ["Customer", "Customer Advocacy Program", "Customer Cohort", "Customer Community", "Customer Education", "Customer Feedback", "Customer Goal", "Customer Health Record", "Customer Journey", "Customer Onboarding", "Customer Segment", "Customer Success Manager", "Revenue Forecast", "Sale"], "last_validated": "2025-11-10T13:43:23.036045"},
    "required_objects": [],
