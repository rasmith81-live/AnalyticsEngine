...
CUSTOMER_SUCCESS_TEAM_UTILIZATION_RATE = {
    ...
    * However, over-optimizing the rate without considering the quality of interactions may result in decreased customer loyalty and trust.
    ...
    """,
    "metadata_": {"modules": ["CUSTOMER_SUCCESS"], "source": "kpidepot.com", "import_date": "2025-11-07", "required_objects": ["Customer", "Customer Advocacy Program", "Customer Cohort", "Customer Community", "Customer Education", "Customer Feedback", "Customer Goal", "Customer Health Record", "Customer Journey", "Customer Onboarding", "Customer Segment", "Customer Success Manager", "Deal", "Lead", "Opportunity", "Product", "Prospect Engagement", "Sales Team"], "last_validated": "2025-11-10T13:43:23.379114"},
    "required_objects": [],
