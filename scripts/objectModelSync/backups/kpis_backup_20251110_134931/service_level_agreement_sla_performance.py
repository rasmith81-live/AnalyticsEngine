...
SERVICE_LEVEL_AGREEMENT_SLA_PERFORMANCE = {
    ...
    * Conversely, declining SLA performance may result in increased customer complaints, escalations, and potential revenue loss.
    ...
    """,
    "metadata_": {"modules": ["CUSTOMER_RETENTION"], "source": "kpidepot.com", "import_date": "2025-11-07", "required_objects": ["Customer", "Customer Advocacy Program", "Customer Cohort", "Customer Community", "Customer Education", "Customer Feedback", "Customer Goal", "Customer Health Record", "Customer Journey", "Customer Onboarding", "Customer Segment", "Customer Success Manager", "Partner Agreement", "Partner Performance Scorecard", "Performance Benchmark", "Performance Scorecard", "Product", "Service Level Agreement"], "last_validated": "2025-11-10T13:43:24.752517"},
    "required_objects": [],
