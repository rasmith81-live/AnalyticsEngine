...
CUSTOMER_ACCOUNT_GROWTH_RATE = {
    ...
    * Conversely, a declining growth rate may necessitate a reevaluation of the product or service offering and customer engagement strategies.
    ...
    """,
    "metadata_": {"modules": ["CUSTOMER_SUCCESS"], "source": "kpidepot.com", "import_date": "2025-11-07", "required_objects": ["Account", "Account Penetration", "Account Plan", "Account Risk", "Customer", "Customer Advocacy Program", "Customer Cohort", "Customer Community", "Customer Education", "Customer Feedback", "Customer Goal", "Customer Health Record", "Customer Journey", "Customer Onboarding", "Customer Segment", "Customer Success Manager", "Deal", "Key Account", "Key Account Manager", "Lead", "Opportunity", "Product Usage", "Revenue Forecast", "Sale"], "last_validated": "2025-11-10T13:43:23.200348"},
    "required_objects": [],
