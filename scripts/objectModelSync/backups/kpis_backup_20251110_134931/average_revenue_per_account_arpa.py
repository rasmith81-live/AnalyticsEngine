...
AVERAGE_REVENUE_PER_ACCOUNT_ARPA = {
    ...
    * Decreasing ARPA may indicate a need to reevaluate customer targeting and product/service offerings to maintain overall revenue levels.
    ...
    """,
    "metadata_": {"modules": ["CUSTOMER_SUCCESS", "SALES_OPERATIONS"], "source": "kpidepot.com", "import_date": "2025-11-07", "required_objects": ["Account", "Account Penetration", "Account Plan", "Account Risk", "Call", "Customer", "Customer Advocacy Program", "Customer Cohort", "Customer Community", "Customer Education", "Customer Feedback", "Customer Goal", "Customer Health Record", "Customer Journey", "Customer Onboarding", "Customer Segment", "Customer Success Manager", "Deal", "Key Account", "Key Account Manager", "Lead", "Opportunity", "Revenue Forecast", "Sale"], "last_validated": "2025-11-10T13:43:23.031835"},
    "required_objects": [],
