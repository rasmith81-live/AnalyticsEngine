...
CUSTOMER_DATA_ACCURACY_RATE = {
    ...
    * However, the initial investment in data validation processes may increase operational costs in the short term.
    ...
    """,
    "metadata_": {"modules": ["CUSTOMER_SUCCESS"], "source": "kpidepot.com", "import_date": "2025-11-07", "required_objects": ["Customer", "Customer Advocacy Program", "Customer Cohort", "Customer Community", "Customer Education", "Customer Feedback", "Customer Goal", "Customer Health Record", "Customer Journey", "Customer Onboarding", "Customer Segment", "Customer Success Manager", "Product", "Service Level Agreement"], "last_validated": "2025-11-10T13:43:23.228823"},
    "required_objects": [],
