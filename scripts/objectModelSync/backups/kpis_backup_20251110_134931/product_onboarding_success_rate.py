...
PRODUCT_ONBOARDING_SUCCESS_RATE = {
    ...
    * However, overly complex onboarding processes aimed at improving the success rate may deter potential customers and impact sales conversion rates.
    ...
    """,
    "metadata_": {"modules": ["CUSTOMER_SUCCESS"], "source": "kpidepot.com", "import_date": "2025-11-07", "required_objects": ["Customer", "Customer Advocacy Program", "Customer Cohort", "Customer Community", "Customer Education", "Customer Feedback", "Customer Goal", "Customer Health Record", "Customer Journey", "Customer Onboarding", "Customer Segment", "Customer Success Manager", "Product", "Product Adoption", "Product Usage", "Sales Process Workflow"], "last_validated": "2025-11-10T13:43:23.971560"},
    "required_objects": [],
