...
CUSTOMER_RETENTION_COST = {
    ...
    * Increasing retention costs without a corresponding increase in customer value may indicate inefficiencies in retention strategies.
    ...
    """,
    "metadata_": {"modules": ["CUSTOMER_RETENTION", "CUSTOMER_SUCCESS", "OUTSIDE_SALES"], "source": "kpidepot.com", "import_date": "2025-11-07", "required_objects": ["Customer", "Customer Advocacy Program", "Customer Cohort", "Customer Community", "Customer Education", "Customer Feedback", "Customer Goal", "Customer Health Record", "Customer Journey", "Customer Onboarding", "Customer Segment", "Customer Success Manager", "Sale"], "replaces": ["ACCOUNT_RETENTION_COSTS"], "last_validated": "2025-11-10T13:43:23.341443"},
    "required_objects": [],
