...
CUSTOMER_FEEDBACK_RESPONSE_RATE = {
    ...
    * Conversely, a low response rate may result in missed opportunities for innovation and customer-centric improvements.
    ...
    """,
    "metadata_": {"modules": ["CUSTOMER_RETENTION", "CUSTOMER_SUCCESS"], "source": "kpidepot.com", "import_date": "2025-11-07", "required_objects": ["Customer", "Customer Advocacy Program", "Customer Cohort", "Customer Community", "Customer Education", "Customer Feedback", "Customer Goal", "Customer Health Record", "Customer Journey", "Customer Onboarding", "Customer Segment", "Customer Success Manager", "Enablement Feedback"], "last_validated": "2025-11-10T13:43:23.267722"},
    "required_objects": [],
