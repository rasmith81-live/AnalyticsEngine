...
EXPANSION_REVENUE_RATE = {
    ...
    * However, overly aggressive upselling or cross-selling can strain customer relationships and impact brand reputation.
    ...
    """,
    "metadata_": {"modules": ["CUSTOMER_SUCCESS"], "source": "kpidepot.com", "import_date": "2025-11-07", "required_objects": ["Customer", "Customer Advocacy Program", "Customer Cohort", "Customer Community", "Customer Education", "Customer Feedback", "Customer Goal", "Customer Health Record", "Customer Journey", "Customer Onboarding", "Customer Segment", "Customer Success Manager", "Expansion Opportunity", "Revenue Forecast", "Sale"], "last_validated": "2025-11-10T13:43:23.481809"},
    "required_objects": [],
