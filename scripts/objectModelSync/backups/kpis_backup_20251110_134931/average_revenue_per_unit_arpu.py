...
* Bar chart for comparisons
    ...
    "metadata_": {"modules": ["BUS_DEV", "SALES_PERFORMANCE"], "value_chains": ["SALES_MGMT"], "source": "kpidepot.com", "required_objects": ["Customer", "Customer Advocacy Program", "Customer Cohort", "Customer Community", "Customer Education", "Customer Feedback", "Customer Goal", "Customer Health Record", "Customer Journey", "Customer Onboarding", "Customer Segment", "Customer Success Manager", "Product", "Quarterly Business Review", "Revenue Forecast", "Sale"], "last_validated": "2025-11-10T13:43:23.034459"},
    "required_objects": [],
