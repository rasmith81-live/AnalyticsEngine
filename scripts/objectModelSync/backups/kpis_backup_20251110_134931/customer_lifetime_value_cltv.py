...
CUSTOMER_LIFETIME_VALUE_CLTV = {
    ...
    * Reducing CLTV could impact revenue and profitability in the long run.
    ...
    """,
    "metadata_": {"modules": ["CUSTOMER_SUCCESS", "SALES_OPERATIONS"], "source": "kpidepot.com", "import_date": "2025-11-07", "required_objects": ["Account", "Account Penetration", "Account Plan", "Account Risk", "Customer", "Customer Advocacy Program", "Customer Cohort", "Customer Community", "Customer Education", "Customer Feedback", "Customer Goal", "Customer Health Record", "Customer Journey", "Customer Onboarding", "Customer Segment", "Customer Success Manager", "Deal", "Key Account", "Key Account Manager", "Lead", "Opportunity", "Product", "Quarterly Business Review", "Revenue Forecast", "Sale", "Sales Team", "Service Level Agreement"], "last_validated": "2025-11-10T13:43:23.297405"},
    "required_objects": [],
    ...
    "sample_data": {
        ...
        "metadata": {
                "generated_date": "2025-11-10T13:43:23.297405",
                "data_points": 12,
                "kpi_type": "count",
