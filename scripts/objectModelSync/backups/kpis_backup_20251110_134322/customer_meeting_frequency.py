...
CUSTOMER_MEETING_FREQUENCY = {
    ...
    * However, a significant increase in meeting frequency without proper alignment with customer needs and goals could lead to resource inefficiency and increased operational costs.
    """,
    "metadata_": {"modules": ["CUSTOMER_SUCCESS"], "source": "kpidepot.com", "import_date": "2025-11-07", "required_objects": ["Customer", "Customer Advocacy Program", "Customer Cohort", "Customer Community", "Customer Education", "Customer Feedback", "Customer Goal", "Customer Health Record", "Customer Journey", "Customer Onboarding", "Customer Segment", "Customer Success Manager", "Meeting", "Sales Team"]},
