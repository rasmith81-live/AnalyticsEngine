...
CUSTOMER_ACQUISITION_COST_CAC_RECOUP_TIME = {
    ...
    * Conversely, longer recoup times can strain resources and impact business growth and expansion plans.
    """,
    "metadata_": {"modules": ["CUSTOMER_RETENTION"], "source": "kpidepot.com", "import_date": "2025-11-07", "required_objects": ["Customer", "Customer Advocacy Program", "Customer Cohort", "Customer Community", "Customer Education", "Customer Feedback", "Customer Goal", "Customer Health Record", "Customer Journey", "Customer Onboarding", "Customer Segment", "Customer Success Manager", "Deal", "Lead", "Opportunity", "Revenue Forecast", "Sale"]},
