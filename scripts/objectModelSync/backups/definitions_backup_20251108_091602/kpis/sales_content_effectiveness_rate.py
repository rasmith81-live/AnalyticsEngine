...
SALES_CONTENT_EFFECTIVENESS_RATE = KPI(
    ...
    * However, changes may also require additional resources for content creation and analysis.
    ...
    metadata_={
        ...
        "required_objects": ["Deal", "Enablement Feedback", "Enablement Platform", "Lead", "Prospect Engagement", "Sale", "Sales Activity", "Sales Appointment", "Sales Assessment", "Sales Call", "Sales Coaching Session", "Sales Content", "Sales Dashboard", "Sales Email", "Sales Forecast", "Sales Playbook", "Sales Process Workflow", "Sales Quota", "Sales Representative", "Sales Team", "Sales Territory", "Sales Training Program"]
    }
)
