...
DEAL_CANCELLATION_RATE = KPI(
    ...
    * However, changes in sales strategies or product offerings to reduce cancellations may require additional resources and investment.
    ...
    metadata_={
        ...
        "required_objects": ["Channel Deal", "Deal", "Sales Activity", "Sales Appointment", "Sales Assessment", "Sales Call", "Sales Coaching Session", "Sales Content", "Sales Dashboard", "Sales Email", "Sales Forecast", "Sales Playbook", "Sales Process Workflow", "Sales Quota", "Sales Representative", "Sales Team", "Sales Territory", "Sales Training Program"]
    }
)
