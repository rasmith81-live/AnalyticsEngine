"""
Revenue per Successful Call KPI
...
REVENUE_PER_SUCCESSFUL_CALL = KPI(
    ...
    kpi_definition="The average revenue generated per successful sales call.",
    expected_business_insights="Assesses the effectiveness of sales calls and the productivity of the sales team.",
    measurement_approach="Calculates the average revenue generated from successful sales calls.",
