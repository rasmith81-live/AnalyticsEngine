...
CUSTOMER_IMPACT_SCORE = KPI(
    ...
    kpi_definition="A measure of the estimated impact or influence of a customer on potential new sales or market perception.",
    expected_business_insights="Reflects the value and effectiveness of the product or service in achieving customer goals.",
    measurement_approach="Measures the influence or change that the company\'s product or service has on a customer\'s business or personal success.",
