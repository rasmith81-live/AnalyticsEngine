"""
Social Media Sentiment Analysis KPI
...
SOCIAL_MEDIA_SENTIMENT_ANALYSIS = KPI(
    ...
    kpi_definition="The evaluation of customer sentiment and satisfaction through social media channels.",
    expected_business_insights="Provides insights into public perception and brand reputation, guiding marketing and PR strategies.",
    measurement_approach="Analyzes customer opinions and emotions expressed on social media about a brand or product.",
    ...
    * However, changes in sentiment may also require adjustments in product offerings, customer service processes, or marketing strategies.
    ...
    metadata_={
        ...
        "required_objects": ["Channel Partner", "Competitive Analysis", "Customer", "Customer Advocacy Program", "Customer Cohort", "Customer Community", "Customer Education", "Customer Feedback", "Customer Goal", "Customer Health Record", "Customer Journey", "Customer Onboarding", "Customer Segment", "Customer Success Manager", "Deal", "Lead", "Opportunity", "Product", "Product Adoption", "Product Usage"]
    }
)
