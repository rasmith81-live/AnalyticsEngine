...
ACCOUNT_PENETRATION_INDEX = KPI(
    ...
    kpi_definition="The number of products or services sold to key accounts relative to the potential number of products or services, indicating cross-selling success.",
    expected_business_insights="Reveals effectiveness of sales strategies and relationship depth within key accounts, identifying cross-selling and upselling opportunities.",
    measurement_approach="Measures the number of products or services sold within an account compared to the total number of possible sales opportunities.",
