...
SALES_ONBOARDING_EFFICIENCY = KPI(
    ...
    * However, rushing the onboarding process may result in lower quality sales interactions and reduced customer satisfaction.
    ...
    metadata_={
        ...
        "required_objects": ["Customer Onboarding", "Deal", "Enablement Feedback", "Enablement Platform", "Lead", "Opportunity", "Product", "Sale", "Sales Activity", "Sales Appointment", "Sales Assessment", "Sales Call", "Sales Coaching Session", "Sales Content", "Sales Dashboard", "Sales Email", "Sales Forecast", "Sales Playbook", "Sales Process Workflow", "Sales Quota", "Sales Representative", "Sales Team", "Sales Territory", "Sales Training Program"]
    }
)
