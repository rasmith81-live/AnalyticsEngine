...
PARTNER_CHURN_RATE = KPI(
    ...
    kpi_definition="The rate at which channel partners cease doing business with the company over a specific period.",
    expected_business_insights="Highlights partner retention challenges and guides strategies to improve partner loyalty and satisfaction.",
    measurement_approach="Calculates the percentage of channel partners that cease collaboration within a given timeframe.",
    ...
    * High partner churn rates can negatively impact customer satisfaction and brand reputation, affecting long-term business growth.
    ...
    metadata_={
        ...
        "required_objects": ["Channel Conflict", "Channel Deal", "Channel Market", "Channel Partner", "Churn Event", "Customer", "Lost Sale", "Partner Agreement", "Partner Incentive", "Partner Performance Scorecard", "Partner Portal", "Partner Training", "Quarterly Business Review", "Sales Activity", "Sales Appointment", "Sales Assessment", "Sales Call", "Sales Coaching Session", "Sales Content", "Sales Dashboard", "Sales Email", "Sales Forecast", "Sales Playbook", "Sales Process Workflow", "Sales Quota", "Sales Representative", "Sales Team", "Sales Territory", "Sales Training Program", "Subscription"]
    }
)
