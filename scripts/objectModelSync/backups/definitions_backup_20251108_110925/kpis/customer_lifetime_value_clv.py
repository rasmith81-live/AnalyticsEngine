...
CUSTOMER_LIFETIME_VALUE_CLV = KPI(
    ...
    * Decreasing CLV can impact revenue forecasts and overall business performance.
    ...
    is_active=True,
    metadata_={
        "modules": ["CUSTOMER_RETENTION", "INSIDE_SALES", "KEY_ACCOUNT_MANAGEMENT", "OUTSIDE_SALES", "SALES_DEVELOPMENT", "SALES_PERFORMANCE", "SALES_STRATEGY"],
        "source": "kpidepot.com",
        ...
        "replaces": ["CLIENT_LIFETIME_VALUE"]}
)
