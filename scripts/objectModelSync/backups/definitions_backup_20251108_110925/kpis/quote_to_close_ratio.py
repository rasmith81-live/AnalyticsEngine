...
QUOTE_TO_CLOSE_RATIO = KPI(
    ...
    * A declining ratio can impact overall sales performance, revenue targets, and the organization\'s competitive position in the market.
    ...
    metadata_={
        ...
        "required_objects": ["Deal", "Opportunity", "Sale", "Sales Activity", "Sales Appointment", "Sales Assessment", "Sales Call", "Sales Coaching Session", "Sales Content", "Sales Dashboard", "Sales Email", "Sales Forecast", "Sales Playbook", "Sales Process Workflow", "Sales Quota", "Sales Representative", "Sales Team", "Sales Territory", "Sales Training Program"]
    }
)
