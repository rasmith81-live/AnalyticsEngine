...
INTERDEPARTMENTAL_COLLABORATION_INDEX = KPI(
    ...
    * On the other hand, poor collaboration can result in missed sales opportunities, customer dissatisfaction, and increased churn.
    ...
    metadata_={
        ...
        "required_objects": ["Account", "Account Penetration", "Account Plan", "Account Risk", "Key Account", "Key Account Manager", "Renewal Management", "Sales Team"]
    }
)
