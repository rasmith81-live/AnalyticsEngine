...
TOTAL_REVENUE = KPI(
    ...
    * Decreasing revenue can impact the ability to invest in research and development or expansion opportunities.
    ...
    metadata_={
        ...
        "required_objects": ["Customer", "Lost Sale", "Partner Performance Scorecard", "Performance Benchmark", "Performance Scorecard", "Product", "Revenue Forecast", "Sale", "Sales Activity", "Sales Appointment", "Sales Assessment", "Sales Call", "Sales Coaching Session", "Sales Content", "Sales Dashboard", "Sales Email", "Sales Forecast", "Sales Playbook", "Sales Process Workflow", "Sales Quota", "Sales Representative", "Sales Team", "Sales Territory", "Sales Training Program"]
    }
)
