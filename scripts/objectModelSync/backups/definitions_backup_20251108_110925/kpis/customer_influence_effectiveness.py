"""
Customer Influence Effectiveness KPI
...
CUSTOMER_INFLUENCE_EFFECTIVENESS = KPI(
    ...
    kpi_definition="The effectiveness of key accounts in influencing the market and bringing in additional business.",
    expected_business_insights="Sheds light on the effectiveness of word-of-mouth and referral marketing efforts.",
    measurement_approach="Measures the impact of customers’ direct and indirect influence on generating new business.",
