"""
Key Account Manager Performance Index KPI
...
KEY_ACCOUNT_MANAGER_PERFORMANCE_INDEX = KPI(
    ...
    kpi_definition="An overall performance metric for key account managers that includes various performance-related KPIs.",
    expected_business_insights="Evaluates the effectiveness of key account managers in growing and maintaining their accounts.",
    measurement_approach="Combines various performance metrics specific to the key account managers.",
