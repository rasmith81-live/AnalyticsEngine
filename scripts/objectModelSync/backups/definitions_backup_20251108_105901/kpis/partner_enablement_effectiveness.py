...
PARTNER_ENABLEMENT_EFFECTIVENESS = KPI(
    ...
    kpi_definition="A measure of how effectively the company enables its partners through resources, tools, and support to maximize their sales efforts.",
    expected_business_insights="Reveals the ROI of enablement programs and guides investment in partner training and resources.",
    measurement_approach="Measures the impact of support, tools, and training provided to partners on their sales performance.",
    ...
    * Conversely, a decline in partner enablement may result in decreased sales performance and market competitiveness.
    ...
    metadata_={
        ...
        "required_objects": ["Channel Conflict", "Channel Deal", "Channel Market", "Channel Partner", "Enablement Feedback", "Enablement Platform", "Partner Agreement", "Partner Incentive", "Partner Performance Scorecard", "Partner Portal", "Partner Training", "Performance Benchmark", "Performance Scorecard", "Sale", "Sales Activity", "Sales Appointment", "Sales Assessment", "Sales Call", "Sales Coaching Session", "Sales Content", "Sales Dashboard", "Sales Email", "Sales Forecast", "Sales Playbook", "Sales Process Workflow", "Sales Quota", "Sales Representative", "Sales Team", "Sales Territory", "Sales Training Program", "Support Ticket"]
    }
)
