...
MARKET_PENETRATION_RATE = KPI(
    ...
    * Decreasing market penetration may result in reduced market share and potential loss of competitive advantage.
    ...
    metadata_={
        ...
        "required_objects": ["Account Penetration", "Channel Market", "Customer", "Customer Success Manager", "Expansion Opportunity", "Market Segment", "Sales Activity", "Sales Appointment", "Sales Assessment", "Sales Call", "Sales Coaching Session", "Sales Content", "Sales Dashboard", "Sales Email", "Sales Forecast", "Sales Playbook", "Sales Process Workflow", "Sales Quota", "Sales Representative", "Sales Team", "Sales Territory", "Sales Training Program"]
    }
)
