...
CUSTOMER_RETENTION_RATE = KPI(
    ...
    * However, focusing solely on retention may neglect the need for continuous growth and expansion into new markets.
    ...
    is_active=True,
    metadata_={
        "modules": ["CUSTOMER_RETENTION", "INSIDE_SALES", "KEY_ACCOUNT_MANAGEMENT", "OUTSIDE_SALES", "SALES_DEVELOPMENT", "SALES_OPERATIONS", "SALES_PERFORMANCE", "SALES_STRATEGY"],
        "source": "kpidepot.com",
