...
ANNUAL_CONTRACT_VALUE_ACV = KPI(
    ...
    * Conversely, a decrease in ACV can impact overall sales performance and may require adjustments in sales strategies and customer engagement approaches.
    ...
    metadata_={
        ...
        "required_objects": ["Account", "Account Penetration", "Account Plan", "Account Risk", "Contract", "Key Account", "Key Account Manager", "Product", "Renewal Management", "Service Level Agreement"]
    }
)
