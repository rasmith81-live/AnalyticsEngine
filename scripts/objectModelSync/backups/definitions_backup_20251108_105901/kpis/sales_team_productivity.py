...
SALES_TEAM_PRODUCTIVITY = KPI(
    ...
    kpi_definition="The revenue generated per sales team member or the number of deals closed per sales team member.",
    expected_business_insights="Helps to assess how effectively the sales team is using their time to generate revenue.",
    measurement_approach="Evaluates the ratio of sales outcomes to the number of sales reps or hours worked.",
    ...
    * Conversely, a decrease in sales team productivity may result in missed opportunities and decreased customer retention, impacting long-term business growth.
    ...
    metadata_={
        ...
        "required_objects": ["Customer", "Deal", "Opportunity", "Product", "Revenue Forecast", "Sale", "Sales Activity", "Sales Appointment", "Sales Assessment", "Sales Call", "Sales Coaching Session", "Sales Content", "Sales Dashboard", "Sales Email", "Sales Forecast", "Sales Playbook", "Sales Process Workflow", "Sales Quota", "Sales Representative", "Sales Team", "Sales Territory", "Sales Training Program"]
    }
)
