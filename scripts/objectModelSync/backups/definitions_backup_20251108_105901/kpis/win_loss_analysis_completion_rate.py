...
WIN_LOSS_ANALYSIS_COMPLETION_RATE = KPI(
    ...
    * However, an increased focus on win-loss analysis may require additional time and resources from sales teams, impacting their overall productivity.
    ...
    metadata_={
        ...
        "required_objects": ["Competitive Analysis", "Deal", "Enablement Feedback", "Enablement Platform", "Opportunity", "Sale", "Sales Activity", "Sales Appointment", "Sales Assessment", "Sales Call", "Sales Coaching Session", "Sales Content", "Sales Dashboard", "Sales Email", "Sales Forecast", "Sales Playbook", "Sales Process Workflow", "Sales Quota", "Sales Representative", "Sales Team", "Sales Territory", "Sales Training Program"]
    }
)
