...
CUSTOMER_EDUCATION_ENGAGEMENT_RATE = KPI(
    ...
    * Conversely, a decline in the engagement rate may indicate a need to reevaluate the effectiveness of the educational content and its impact on overall business performance.
    ...
    metadata_={
        ...
        "required_objects": ["Customer", "Customer Advocacy Program", "Customer Cohort", "Customer Community", "Customer Education", "Customer Feedback", "Customer Goal", "Customer Health Record", "Customer Journey", "Customer Onboarding", "Customer Segment", "Customer Success Manager", "Lead", "Partner Training", "Prospect Engagement", "Sales Content", "Sales Training Program", "Service Level Agreement", "Training Program"],
        "replaces": ["CUSTOMER_EDUCATION_COMPLETION_RATE"]}
)
