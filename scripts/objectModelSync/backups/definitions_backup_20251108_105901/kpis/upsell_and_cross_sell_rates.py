...
UPSELL_AND_CROSS_SELL_RATES = KPI(
    ...
    * However, a focus solely on upselling and cross-selling may impact customer trust and loyalty if not done in a customer-centric manner.
    ...
    metadata_={
        ...
        "required_objects": ["Customer", "Customer Success Manager", "Partner Performance Scorecard", "Performance Benchmark", "Performance Scorecard", "Product", "Purchase History", "Sale", "Sales Activity", "Sales Appointment", "Sales Assessment", "Sales Call", "Sales Coaching Session", "Sales Content", "Sales Dashboard", "Sales Email", "Sales Forecast", "Sales Playbook", "Sales Process Workflow", "Sales Quota", "Sales Representative", "Sales Team", "Sales Territory", "Sales Training Program"]
    }
)
