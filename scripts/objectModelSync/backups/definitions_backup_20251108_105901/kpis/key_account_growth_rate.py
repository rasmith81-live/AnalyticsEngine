...
KEY_ACCOUNT_GROWTH_RATE = KPI(
    ...
    kpi_definition="The growth rate of sales within key accounts that are critical to the company\'s success.",
    expected_business_insights="Reflects the effectiveness of account management and the potential for further development of strategic customer relationships.",
    measurement_approach="Measures the revenue growth rate for key accounts over a specific period.",
