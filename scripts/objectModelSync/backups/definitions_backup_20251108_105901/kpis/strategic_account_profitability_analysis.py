"""
Strategic Account Profitability Analysis KPI
...
STRATEGIC_ACCOUNT_PROFITABILITY_ANALYSIS = KPI(
    ...
    kpi_definition="A detailed analysis of profits derived from each strategic account, helping to identify the most valuable relationships.",
    expected_business_insights="Provides insights into the financial impact of strategic accounts, guiding resource allocation and strategy.",
    measurement_approach="Examines the profitability of each strategic account.",
    ...
    * Conversely, declining profitability may require cost-cutting measures or a reevaluation of the account management approach.
    ...
    metadata_={
        ...
        "required_objects": ["Account", "Account Penetration", "Account Plan", "Account Risk", "Competitive Analysis", "Customer", "Key Account", "Key Account Manager", "Renewal Management", "Revenue Forecast", "Sale", "Strategic Initiative", "Strategic Review"]
    }
)
