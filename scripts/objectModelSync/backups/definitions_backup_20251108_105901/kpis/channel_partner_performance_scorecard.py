"""
Channel Partner Performance Scorecard KPI
...
CHANNEL_PARTNER_PERFORMANCE_SCORECARD = KPI(
    ...
    kpi_definition="The performance of individual channel partners in areas such as sales growth, market share, and customer satisfaction.",
    expected_business_insights="Enables a comprehensive assessment of partners, identifying top performers and those in need of support.",
    measurement_approach="Considers various metrics such as sales, growth, customer satisfaction to evaluate partner performance.",
